// Proxies /api/* same-origin to the worker, so the browser sees chasa.io on both ends instead of
// a cross-site request to the workers.dev host. Without this, the session cookie set on login is

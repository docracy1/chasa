...
*A JSA breaks a job into its individual physical steps (not just "operating the machine is risky") — that step-by-step granularity is what surfaces hazards a general risk assessment misses.*`,
  },
  {
    ...
    seoTitle: "Free Purchase Requisition Form Template",
    description: "Free purchase requisition form template — an employee's internal request for approval before a purchase order is issued.",
    category: "Business",
    bodyMarkdown: `# Purchase Requisition Form

**Requested by:** [Name/Department] · **Date:** [Date]

## Item(s) Requested

| Description | Qty | Estimated Unit Cost | Estimated Total |
|-------------|-----|--------------------------|----------------------|
| [Item] | [Qty] | [Cost] | [Total] |
...
## Budget
Budget line/code: [Code] · Amount remaining in budget: [Amount]

## Approval

| Role | Name | Decision | Date |
|------|------|----------|------|
| Manager | [Name] | [ ] Approved [ ] Rejected | [Date] |
| Finance (if required) | [Name] | [ ] Approved [ ] Rejected | [Date] |

*A requisition is the internal APPROVAL step before a purchase order is issued to a vendor — keeping the two separate creates a clean audit trail of who requested and who approved each purchase.*`,
  },
  {
    slug: "wedding-booking-form-template",
    name: "Wedding Booking Form",
    seoTitle: "Free Wedding Booking Form Template",
    description: "Free wedding booking form template for a venue, photographer, or vendor confirming a couple's wedding date and services.",
    category: "Business",
    bodyMarkdown: `# Wedding Booking Form

**Couple:** [Names] · **Wedding Date:** [Date]

## Contact Information
Primary contact: [Name] · Email: [Email] · Phone: [Phone]

## Event Details
Ceremony time: [Time] · Reception time: [Time]
Venue: [Name/Address]
Estimated guest count: [Number]

## Services Booked
[ ] [Service 1 — e.g. photography]  [ ] [Service 2]  [ ] [Service 3]

## Package/Pricing
Package selected: [Name] · Total price: [Amount]
Deposit: [Amount], due [Date] · Balance: due [Date]

## Special Requests
[Any specific requests or details relevant to the day]

## Agreement
[ ] I have reviewed and agree to the vendor's terms and cancellation policy: [Link/summary]

Signature: ______________________  Date: ____________

*Locking the exact date, package, and deposit terms into one signed form — not scattered across emails — is what prevents a scheduling mix-up on one of the most date-sensitive bookings a vendor takes.*`,
  },
  {
    slug: "payoff-letter-template",
    name: "Payoff Letter",
    seoTitle: "Free Payoff Letter Template",
    description: "Free payoff letter template confirming the exact amount needed to fully pay off a loan.",
    category: "Finance",
    bodyMarkdown: `# Payoff Letter
...
This letter confirms the payoff amount for the above loan as of [Payoff Date].

## Payoff Details
Outstanding principal: [Amount]
Accrued interest through [Date]: [Amount]
Any fees due: [Amount]
**Total Payoff Amount: [Amount]**

## Instructions
This payoff figure is valid through [Expiration Date]. Payment must be received by [Method — wire, cashier's check] to: [Payment instructions].

Upon receipt of the full amount above, the loan will be considered paid in full and [Lender Name] will [release any lien / send confirmation of payoff / return collateral, as applicable].

---
Issued by: ______________________  Date: ____________
[Name, Title, Lender]

*A payoff amount is only valid through its stated expiration date because interest continues to accrue daily — always request a fresh payoff letter if you don't close by that date, rather than assuming the old number still applies.*`,
  },
  {
    slug: "meeting-request-letter-template",
    name: "Meeting Request Letter",
    seoTitle: "Free Meeting Request Letter Template",
    description: "Free meeting request letter template for formally requesting time with someone for a specific purpose.",
    category: "Business",
    bodyMarkdown: `# Meeting Request Letter

[Date]

Dear [Recipient Name],

I would like to request a meeting to discuss [specific topic/purpose].

## Purpose
[Why this meeting matters — the specific decision, question, or update it's meant to address.]

## Proposed Details
Suggested date/time: [Date/Time] (or: "please let me know what works for your schedule")
...
Please let me know if this timing works, or suggest an alternative. Thank you for your time.

Sincerely,
[Your Name]
[Contact Information]

*Stating the specific purpose and topics up front (not just "can we meet?") makes it much easier for a busy recipient to say yes quickly.*`,
  },
  {
    slug: "sign-in-form-template",
    name: "Sign-In Form",
    seoTitle: "Free Sign-In Form Template",
    description: "Free sign-in form template for tracking visitors, attendees, or guests at an office, event, or building.",
    category: "Business",
    bodyMarkdown: `# Sign-In Form

**Location/Event:** [Name] · **Date:** [Date]

| Name | Company/Organization | Time In | Time Out | Host/Purpose |
|------|--------------------------|---------|----------|-------------------|
| [Name] | [Company] | [Time] | [Time] | [Host/Purpose] |
| [Name] | [Company] | [Time] | [Time] | [Host/Purpose] |

## Visitor Acknowledgment (if applicable)
[ ] I agree to follow the site's safety/security policies while on premises.

## Emergency Use
In case of emergency evacuation, this sign-in sheet may be used to account for all visitors present.

*Keeping the sign-in sheet current throughout the day (not just at the start) is what actually makes it useful for the one scenario it matters most — an emergency evacuation headcount.*`,
  },
  {
    slug: "homestay-agreement-template",
    name: "Homestay Agreement",
    seoTitle: "Free Homestay Agreement Template",
    description: "Free homestay agreement template for a host family hosting a student or visitor in their home.",
    category: "Real Estate",
    bodyMarkdown: `# Homestay Agreement

**Host:** [Name] · **Guest:** [Name]
**Address:** [Address]
**Stay Period:** [Start Date] – [End Date]

## 1. Accommodations
Guest will have [private room / shared room], with access to [shared bathroom, kitchen, common areas].

## 2. Fees
Total fee: [Amount] per [week/month], covering: [room, meals — specify which meals if any].

## 3. House Rules
[Curfew if any, guest policy, quiet hours, smoking policy, chores expected.]

## 4. Cultural Exchange Expectations (if applicable)
[If this is part of a language/cultural exchange program: expectations around shared meals, conversation practice, etc.]

## 5. Emergency Contact
Guest's emergency contact: [Name, Phone, Relationship]
Program coordinator (if applicable): [Name, Phone]

## 6. Ending the Arrangement
Either party may end this arrangement with [Notice Period] notice, or [immediately for serious violations of house rules].

---
Host: ______________________  Date: ____________
Guest: ______________________  Date: ____________

*If this homestay is arranged through a school or exchange program, check whether the program has its own required agreement/insurance terms that take precedence over a private arrangement like this one.*`,
  },
  {
    slug: "notice-of-election-template",
    name: "Notice of Election",
    seoTitle: "Free Notice of Election Template",
    description: "Free notice of election template for announcing an upcoming election of officers, board members, or representatives.",
    category: "Business",
    bodyMarkdown: `# Notice of Election

**Organization:** [Organization Name] · **Date:** [Date]

This notice announces the upcoming election for the following position(s): [List positions — e.g. "Board of Directors, 3 seats"].

## Key Dates
Nominations open: [Date] · Nominations close: [Date]
Election date: [Date]
Results announced: [Date]

## Eligibility to Vote
[Who may vote — e.g. "all members in good standing as of [Date]"]

## Eligibility to Run
[Requirements to be nominated — e.g. membership duration, no conflicts of interest]

## How to Vote
[Method — in-person, mail ballot, online — and where/how to submit]

## Candidates (once nominations close)
...
*Publishing the exact eligibility rules and dates in this notice — rather than deciding them ad hoc later — is what prevents a contested election result from being challenged on procedural grounds.*`,
  },
  {
    slug: "letter-of-intent-to-dismiss-template",
    name: "Letter of Intent to Dismiss",
    seoTitle: "Free Letter of Intent to Dismiss Template",
    description: "Free letter of intent to dismiss template — notifies an employee that termination is being considered, before a final decision.",
    category: "HR",
    bodyMarkdown: `# Letter of Intent to Dismiss

[Date]

Dear [Employee Name],

This letter is to inform you that [Company Name] is considering terminating your employment, for the following reason(s):

## Reason(s)
[Specific, factual reasons — reference prior documented warnings/performance issues if applicable.]

## Your Opportunity to Respond
Before a final decision is made, you have the opportunity to respond to this notice. Please provide any response, in writing or at a meeting scheduled for [Date/Time], by [Deadline].

## Next Steps
After considering your response (if any), [Company Name] will communicate its final decision by [Date].

Please contact [HR Contact] with any questions about this process.

Sincerely,
[Name, Title]

*This document is provided for informational and educational purposes only and does not constitute legal advice. Giving the employee a genuine, documented opportunity to respond before a final decision — rather than treating this as a formality — is often what protects a company if the termination is later challenged.*`,
  },
  {
    slug: "travel-voucher-form-template",
    name: "Travel Voucher Form",
    seoTitle: "Free Travel Voucher Form Template",
    description: "Free travel voucher form template for requesting advance funds or reimbursement for business travel.",
    category: "Finance",
    bodyMarkdown: `# Travel Voucher

**Employee:** [Name] · **Date:** [Date]
**Trip Purpose:** [Description] · **Dates:** [Start Date] – [End Date]

## Estimated Expenses (for advance request)
| Category | Estimated Amount |
|----------|----------------------|
| Airfare/Transportation | [Amount] |
| Lodging | [Amount] |
...
## Post-Trip Reconciliation (complete after travel)
Actual expenses: [Amount] · Advance received: [Amount]
[ ] Amount owed to employee: [Amount]
[ ] Amount owed to company (unused advance): [Amount]

*Requiring reconciliation against actual receipts after the trip (not just approving the advance and forgetting it) is what keeps a travel advance program from quietly leaking money.*`,
  },
  {
    slug: "standing-order-mandate-template",
    name: "Standing Order Mandate",
    seoTitle: "Free Standing Order Mandate Template",
    description: "Free standing order mandate template — authorizes a bank to make automatic recurring payments from an account.",
    category: "Finance",
    bodyMarkdown: `# Standing Order Mandate

**Account Holder:** [Name] · **Account Number:** [Number]
**Bank:** [Bank Name]

## Payment Instructions
Please pay: [Payee Name]
Payee's account details: [Account/IBAN, sort code/routing number]
Amount: [Amount]
Frequency: [Monthly/Weekly/Other]
First payment date: [Date]
Final payment date (or "until cancelled"): [Date]
Reference: [Payment reference for the payee to identify it]

## Authorization
I authorize [Bank Name] to make the above payments from my account until I instruct otherwise in writing.

Account holder signature: ______________________  Date: ____________
...
*This document is provided for informational and educational purposes only and does not constitute legal advice. This affidavit should be recorded with the county recorder's office (along with a certified death certificate) to formally update the public record — requirements vary by state, so confirm the exact process with your county recorder or a real estate/probate attorney.*`,
  },
  {
    ...
    description: "Free strategic alliance agreement template for two companies collaborating toward shared business goals without merging.",
    category: "Business",
    bodyMarkdown: `# Strategic Alliance Agreement
...
## 1. Purpose
The parties agree to form a strategic alliance to [Shared goal — e.g. "jointly develop and market a combined solution to enterprise customers"], while remaining separate, independent companies.

## 2. Scope of Collaboration
[Specific areas of collaboration — e.g. joint product development, shared sales efforts, co-marketing.]

## 3. Contributions
**Party A will contribute:** [Resources, technology, market access, etc.]
**Party B will contribute:** [Resources, technology, market access, etc.]

## 4. Governance
[How joint decisions are made — e.g. a steering committee with representatives from both companies, meeting [Frequency].]

## 5. Revenue/Cost Sharing (if applicable)
[Describe any shared revenue or cost arrangement resulting from the alliance.]

## 6. Exclusivity
[State whether either party is restricted from forming similar alliances with others in this specific area, and any territory/scope limits.]

## 7. Intellectual Property
[Each party retains its own pre-existing IP; describe ownership of any jointly developed IP.]
...
*This document is provided for informational and educational purposes only and does not constitute legal advice. A strategic alliance is looser than a joint venture (no new shared entity is formed) — be explicit about governance and IP ownership, since ambiguity there is where these relationships most often sour.*`,
  },
  {
    slug: "salary-reduction-agreement-template",
    name: "Salary Reduction Agreement",
    seoTitle: "Free Salary Reduction Agreement Template",
    description: "Free salary reduction agreement template — documents an employee's agreed reduction in pay, e.g. for a retirement contribution or cost-saving measure.",
    category: "HR",
    bodyMarkdown: `# Salary Reduction Agreement
...
[Choose one: "Employee elects to reduce salary by [Amount/%] to contribute to [retirement plan/benefit]" OR "Company-wide cost reduction measure affecting all employees at [Level]."]

## 2. New Compensation
Previous salary: [Amount] · New salary: [Amount], effective [Date].

## 3. Duration
[State whether this is permanent, or temporary with a review/reversion date — e.g. "in effect until [Date], to be reviewed at that time."]

## 4. Benefits Impact
[Note whether this reduction affects any benefits calculated as a % of salary — e.g. retirement matching, life insurance coverage.]

## 5. Voluntary Acknowledgment (if elective)
Employee acknowledges this reduction is voluntary and elected for the purpose stated above.

---
Employer: ______________________  Date: ____________
Employee: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. A salary reduction imposed unilaterally (not employee-elected) can, in some jurisdictions, be treated as a "constructive dismissal" if severe enough — confirm your state/country's rules before reducing pay without the employee's clear agreement.*`,
  },
  {
    slug: "counter-offer-template",
    name: "Counter Offer",
    seoTitle: "Free Counter Offer Template",
    description: "Free counter offer letter template for responding to a job offer, purchase offer, or negotiation with revised terms.",
    category: "Business",
    bodyMarkdown: `# Counter Offer

[Date]

Dear [Recipient Name],

Thank you for [the offer / your proposal] regarding [Subject]. I appreciate the offer and would like to propose the following adjustments.

## Original Terms
[Brief restatement of what was originally offered.]

## Proposed Changes
| Term | Original | Proposed |
|------|----------|-----------|
| [Term — e.g. salary/price] | [Original] | [Proposed] |
| [Term] | [Original] | [Proposed] |

## Why This Adjustment
[Brief, professional justification — market rate, comparable offers, specific value you bring, etc.]

I remain very interested in [moving forward / this opportunity] and am happy to discuss further.

Sincerely,
[Your Name]

*A counter offer that includes a brief, specific justification (not just a bigger number) tends to be received better and negotiated more smoothly than one that arrives with no explanation.*`,
  },
  {
    slug: "investment-advisory-agreement-template",
    name: "Investment Advisory Agreement",
    seoTitle: "Free Investment Advisory Agreement Template",
    description: "Free investment advisory agreement outline between a registered investment adviser and a client.",
    category: "Finance",
    bodyMarkdown: `# Investment Advisory Agreement

**Adviser:** [Name/Firm, registration # if applicable]
**Client:** [Name]
**Effective Date:** [Date]

## 1. Services
Adviser will provide investment advisory services, including: [e.g. portfolio management, financial planning, investment recommendations], based on Client's stated objectives and risk tolerance (see attached questionnaire).

## 2. Discretionary Authority
[State whether Adviser has discretion to make trades without prior approval for each transaction, or requires Client's consent for each trade.]

## 3. Fees
Advisory fee: [%] of assets under management annually, billed [Frequency], [or flat fee of [Amount]].

## 4. Custody
Client's assets are held at [Custodian Name], not by Adviser directly. Adviser [does/does not] have authority to withdraw funds beyond agreed fees.

## 5. Risk Disclosure
Client acknowledges that investing involves risk, including possible loss of principal, and that past performance does not guarantee future results.

## 6. Conflicts of Interest
[Disclose any conflicts — e.g. compensation from third parties for recommending certain products.]

## 7. Termination
Either party may terminate this Agreement with [Notice Period] written notice.

---
Adviser: ______________________  Date: ____________
Client: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal or investment advice. Providing investment advice for compensation generally requires registration as an investment adviser (with the SEC or state regulators, depending on assets under management) — this is a heavily regulated activity; use a licensed securities attorney to prepare an actual advisory agreement.*`,
  },
  {
    slug: "directors-service-agreement-template",
    name: "Director's Service Agreement",
    seoTitle: "Free Director's Service Agreement Template",
    description: "Free director's service agreement template — the employment-style contract for an executive director's role and compensation.",
    category: "Business",
    bodyMarkdown: `# Director's Service Agreement
...
## 1. Appointment
Company appoints Director as [Executive Director / Managing Director / other title], subject to shareholder approval where required by the Company's bylaws.

## 2. Duties
Director will [manage the Company's day-to-day affairs / oversee [specific area]], reporting to the Board.

## 3. Compensation
Base compensation: [Amount] per year, plus [bonus structure/equity, if applicable].

## 4. Term
This Agreement runs for [Term], [with automatic renewal unless either party gives notice].

## 5. Termination
[Grounds for termination — resignation, removal by shareholder vote per bylaws, for cause — and any severance owed.]

## 6. Confidentiality and Non-Compete
[Reference or include confidentiality obligations and any post-termination restrictions, consistent with enforceability limits in your jurisdiction.]

## 7. Indemnification
Company will indemnify Director for actions taken in good faith in this role, to the extent permitted by [State] law and the Company's bylaws.
...
---
Company: ______________________  Date: ____________
Director: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. A director's removal and compensation terms need to be consistent with the Company's own bylaws/articles — have a licensed corporate attorney confirm this agreement doesn't conflict with those governing documents.*`,
  },
  {
    slug: "exclusivity-agreement-template",
    name: "Exclusivity Agreement",
    seoTitle: "Free Exclusivity Agreement Template",
    description: "Free exclusivity agreement template — one party agrees to deal only with the other for a specific matter, during a defined period.",
    category: "Business",
    bodyMarkdown: `# Exclusivity Agreement

**Party A:** [Name]
**Party B:** [Name]
**Subject:** [The specific deal, negotiation, or relationship this exclusivity covers]
**Date:** [Date]

## 1. Exclusivity
For a period of [Duration] from the date above, [Party A] will not negotiate, discuss, or enter into any agreement with any other party regarding [Subject], and will deal exclusively with [Party B].

## 2. Purpose
This exclusivity period is intended to allow the parties to [complete due diligence / finalize a definitive agreement / negotiate final terms] without competing offers.

## 3. Consideration
[If Party A is being compensated for granting exclusivity, state the amount/terms; if not, state that mutual good-faith negotiation is the consideration.]

## 4. Expiration
This exclusivity automatically expires at the end of the period above unless extended in writing by both parties.

## 5. No Obligation to Complete
This Agreement does not obligate either party to actually complete the underlying transaction — it only restricts Party A from dealing with others during the exclusivity period.
...
*Setting a firm expiration date (Section 4) protects the party granting exclusivity from being indefinitely locked out of other opportunities if the other side stalls negotiations.*`,
  },
  {
    slug: "lessons-learned-template",
    name: "Lessons Learned",
    seoTitle: "Free Lessons Learned Template",
    description: "Free lessons learned template for capturing what worked and what didn't at the end of a project.",
    category: "Business",
    bodyMarkdown: `# Lessons Learned: [Project Name]

**Prepared by:** [Name] · **Date:** [Date]

## Project Summary
[Brief recap — what the project was and its outcome.]
...
## What Didn't Go Well
| Item | Root Cause | Do Differently Next Time |
|------|----------------|------------------------------|
| [Item] | [Cause] | [Change] |

## Unexpected Surprises
[Anything that came up that wasn't anticipated in planning, positive or negative.]

## Recommendations for Future Projects
[Specific, actionable takeaways — not generic advice.]

*A lessons-learned document that gets filed away unread doesn't help anyone — the real value comes from actually reviewing it before starting the next similar project.*`,
  },
  {
    slug: "limited-warranty-template",
    name: "Limited Warranty",
    seoTitle: "Free Limited Warranty Template",
    description: "Free limited warranty template for a product — what's covered, for how long, and what's excluded.",
    category: "Business",
    bodyMarkdown: `# Limited Warranty

**Product:** [Product Name/Model]
**Manufacturer/Seller:** [Company Name]

[Company Name] warrants this product against defects in materials and workmanship for a period of [Duration] from the date of purchase.

## What's Covered
[Describe the specific coverage — e.g. "manufacturing defects that cause the product to fail under normal use."]

## What's Not Covered
This warranty does not cover: damage from misuse, accident, unauthorized modification, normal wear and tear, or use inconsistent with the product's instructions.

## Remedy
If a covered defect occurs during the warranty period, [Company Name] will, at its option: repair the product, replace it, or refund the purchase price.

## How to Make a Claim
Contact [Email/Phone] with your proof of purchase and a description of the issue. [Describe any required return process.]

## Limitation of Liability
This warranty is the sole remedy for defective products. [Company Name] is not liable for indirect, incidental, or consequential damages, to the extent permitted by law.

## Your Legal Rights
This warranty gives you specific legal rights; you may also have other rights that vary by state/country and are not affected by this warranty.

*This document is provided for informational and educational purposes only and does not constitute legal advice. Consumer protection law in many jurisdictions imposes minimum warranty rights that can't be waived — this document should supplement those legal protections, not attempt to override them.*`,
  },
  {
    slug: "booth-rental-agreement-template",
    name: "Booth Rental Agreement",
    seoTitle: "Free Booth Rental Agreement Template",
    description: "Free booth rental agreement template for renting exhibition, market, or trade show booth space.",
    category: "Business",
    bodyMarkdown: `# Booth Rental Agreement

**Organizer/Venue:** [Name]
**Vendor:** [Business Name]
**Event:** [Event Name] · **Date(s):** [Date(s)]
**Booth #/Location:** [Number/Description]

## 1. Booth Fee
Total fee: [Amount], due [Timing].

## 2. What's Included
[e.g. table, chairs, power access, Wi-Fi — specify what comes with the booth vs. what the vendor must bring.]

## 3. Setup and Breakdown
Setup window: [Time/date] · Breakdown by: [Time/date]

## 4. Vendor Requirements
Vendor will [provide their own product liability insurance / have appropriate permits for sales, if applicable].

## 5. Rules of Conduct
[Sound levels, aisle space requirements, prohibited items, sales tax collection responsibility.]

## 6. Cancellation
[Refund policy for cancellation, by how many days before the event.]

## 7. Liability
Vendor is responsible for their own goods/equipment; Organizer is not liable for loss or damage to vendor property.

---
Organizer: ______________________  Date: ____________
Vendor: ______________________  Date: ____________

*Specifying exactly what's included (power, tables, Wi-Fi) prevents vendors from arriving unprepared for basics they assumed would be provided.*`,
  },
  {
    slug: "security-plan-template",
    name: "Security Plan",
    seoTitle: "Free Security Plan Template",
    description: "Free security plan template for protecting a facility, event, or organization's physical and information assets.",
    category: "Business",
    bodyMarkdown: `# Security Plan — [Facility/Event/Organization Name]

**Prepared by:** [Name] · **Date:** [Date]

## Scope
[What this plan covers — a facility, an event, or an organization's overall security posture.]

## Assets to Protect
[People, physical property, information/data — be specific.]

## Threats Considered
[e.g. unauthorized access, theft, data breach, workplace violence — relevant to your context.]

## Physical Security Measures
[Access control, locks, cameras, visitor sign-in, alarm systems.]

## Information Security Measures (if applicable)
[Password policy, data access controls, device security.]

## Roles and Responsibilities
| Role | Name | Responsibility |
|------|------|-----------------|
| Security lead | [Name] | [Responsibility] |

## Incident Response
[Who to contact and what to do if a security incident occurs.]

## Review Schedule
This plan is reviewed [Frequency] or after any significant incident.

*A security plan that's never tested (via a drill, a walkthrough, or a mock incident) often has gaps that only surface during an actual event — schedule a real test, not just a document review.*`,
  },
  {
    slug: "consortium-agreement-template",
    name: "Consortium Agreement",
    seoTitle: "Free Consortium Agreement Template",
    description: "Free consortium agreement template for multiple organizations jointly pursuing a project, grant, or bid together.",
    category: "Business",
    bodyMarkdown: `# Consortium Agreement

**Lead Organization:** [Name]
**Consortium Members:** [List all member organizations]
**Project:** [Description]
**Date:** [Date]

## 1. Purpose
The parties form a consortium to jointly pursue [Project/grant/bid], with [Lead Organization] coordinating the effort.
...
[If applicable: how any grant funding or costs are distributed among members.]

## 4. Intellectual Property
[Describe ownership of IP created individually by each member vs. jointly by the consortium.]

## 5. Decision-Making
[How consortium-wide decisions are made — e.g. Lead Organization has final say, or majority vote of members.]

## 6. Liability
Each member is responsible for its own portion of the work; [describe whether liability is joint or several among members].

## 7. Withdrawal
[Process and notice required for a member to withdraw from the consortium before project completion.]

## 8. Term
This Agreement remains in effect for the duration of the project, through [final reporting/close-out date].

---
[Each member organization signs:]
Member: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Many grant funders (especially EU/multinational research programs) require a specific consortium agreement format as a condition of funding — check the funder's requirements before using a generic template.*`,
  },
  {
    slug: "letter-of-comfort-template",
    name: "Letter of Comfort",
    seoTitle: "Free Letter of Comfort Template",
    description: "Free letter of comfort template — a parent company provides assurance (short of a full guarantee) supporting a subsidiary's obligations.",
    category: "Finance",
    bodyMarkdown: `# Letter of Comfort

[Parent Company Name/Letterhead]
[Date]

[Beneficiary Name]

**RE: Letter of Comfort — [Subsidiary Name]**

Dear [Beneficiary Name],

We understand that [Subsidiary Name], our [wholly-owned subsidiary / affiliate], is entering into [Agreement/transaction] with you.

## Statement of Support
[Parent Company Name] confirms that:
1. [Subsidiary Name] is our [subsidiary/affiliate].
2. We are aware of the above transaction and support [Subsidiary Name]'s participation in it.
3. [Optional, and only if genuinely intended: "It is our current intention to ensure [Subsidiary Name] has sufficient resources to meet its obligations."]

## Not a Guarantee
This letter is provided as a statement of comfort and support only. **It is not a legal guarantee of [Subsidiary Name]'s obligations and creates no binding financial obligation on [Parent Company Name].**

Sincerely,
[Name, Title]
[Parent Company Name]

*This document is provided for informational and educational purposes only and does not constitute legal advice. Letters of comfort are DELIBERATELY weaker than a guarantee — courts in some jurisdictions have found certain "comfort letters" legally binding anyway if the language was too strong. If you actually intend a binding guarantee, use a proper Letter of Guarantee instead; if you don't, keep this letter's language as non-committal as shown above.*`,
  },
  {
    slug: "device-security-policy-template",
    name: "Device Security Policy",
    seoTitle: "Free Device Security Policy Template",
    description: "Free device security policy template covering laptops, phones, and other company or personal devices used for work.",
    category: "HR",
    bodyMarkdown: `# Device Security Policy

**Company:** [Company Name] · **Effective Date:** [Date]

## Purpose
This policy protects company data accessed or stored on devices used for work, whether company-issued or personal (BYOD).

## Required Security Measures
All devices used for work must have: a passcode/biometric lock, up-to-date operating system and security patches, full-disk encryption where supported, and [approved antivirus/endpoint protection, if required].

## Company-Issued Devices
[Ownership, acceptable use, and expectations for return upon termination.]

## Personal Devices (BYOD)
[If personal devices access company systems: describe required security app/MDM enrollment, and Company's right to remote-wipe company data (not personal data) if the device is lost or the employee leaves.]

## Public Wi-Fi
Employees should use a VPN when accessing company systems on public Wi-Fi, or avoid sensitive work on unsecured networks.

## Lost or Stolen Devices
Report a lost or stolen device to [IT contact] immediately so access can be revoked.

## Prohibited
Devices used for work may not be [jailbroken/rooted], and company data should not be stored on unapproved personal cloud storage.

---
Acknowledged by: ______________________  Date: ____________

*Being specific that a remote wipe only removes COMPANY data/apps (not personal photos) on a BYOD device is what actually gets employee buy-in for this policy — vague wipe language creates unnecessary resistance.*`,
  },
  {
    slug: "payment-schedule-template",
    name: "Payment Schedule",
    seoTitle: "Free Payment Schedule Template",
    description: "Free payment schedule template for laying out installment amounts and due dates for a project or purchase.",
    category: "Finance",
    bodyMarkdown: `# Payment Schedule

**Client:** [Name] · **Total Amount:** [Amount]
**Related to:** [Project/Invoice/Contract reference]

| Payment # | Milestone/Due Date | Amount | Status |
|-----------|---------------------|--------|--------|
| 1 | [Milestone/Date] | [Amount] | [ ] Paid |
| 2 | [Milestone/Date] | [Amount] | [ ] Paid |
| 3 | [Milestone/Date] | [Amount] | [ ] Paid |
...
## Late Payments
[Any late fee or consequence for a missed payment date.]

---
Agreed by: ______________________  Date: ____________

*Tying payments to specific milestones (not just calendar dates) keeps both sides aligned on what triggers each payment — useful whenever the underlying work could run ahead of or behind schedule.*`,
  },
  {
    slug: "wellness-policy-template",
    name: "Wellness Policy",
    seoTitle: "Free Workplace Wellness Policy Template",
    description: "Free workplace wellness policy template outlining an employer's health and wellbeing programs for employees.",
    category: "HR",
    bodyMarkdown: `# Workplace Wellness Policy

**Company:** [Company Name] · **Effective Date:** [Date]

## Purpose
[Company Name] is committed to supporting employee health and wellbeing through the programs described below.

## Wellness Programs Offered
[e.g. gym membership subsidy, mental health resources/EAP, wellness stipend, on-site fitness classes, ergonomic assessments.]

## Mental Health Support
[Describe available resources — EAP, counseling benefits, mental health days if distinct from standard sick leave.]

## Participation
Participation in wellness programs is voluntary and does not affect performance evaluations. [If any incentive is tied to participation, describe it and confirm it complies with applicable wellness-program regulations.]

## Privacy
Any health information shared as part of wellness programs is kept confidential and is not shared with managers or used in employment decisions.

## How to Access
[How employees sign up for or access these benefits.]

---
Questions: [HR Contact]

*This document is provided for informational and educational purposes only and does not constitute legal advice. If wellness program participation is tied to any financial incentive, US employers should confirm compliance with ADA and HIPAA wellness program rules, which limit how large an incentive can be and require confidentiality of health data.*`,
  },
  {
    slug: "collection-agreement-template",
    name: "Collection Agreement",
    seoTitle: "Free Collection Agreement Template",
    description: "Free collection agreement template — a creditor engages a collection agency to pursue an unpaid debt for a contingency fee.",
    category: "Finance",
    bodyMarkdown: `# Collection Agreement

**Creditor:** [Name]
**Collection Agency:** [Name, license # if required in your state]
**Effective Date:** [Date]

## 1. Assignment of Accounts
Creditor assigns the following delinquent account(s) to Agency for collection: [Description/account list, or reference to an attached schedule].

## 2. Agency's Authority
Agency is authorized to contact the debtor(s) to collect the amounts owed, in compliance with the Fair Debt Collection Practices Act (US) and any other applicable debt collection law.

## 3. Fee
Agency's fee is [%] of amounts actually collected ("contingency fee"), paid only on successful collection. No fee is owed on accounts not collected.

## 4. Remittance
Agency will remit collected funds (less its fee) to Creditor within [Number] days of receipt.

## 5. Reporting
Agency will provide Creditor with [Frequency] status reports on assigned accounts.

## 6. Compliance
Agency represents it is licensed to collect debts in the relevant jurisdictions and will comply with all applicable debt collection laws.

## 7. Term
This Agreement runs for [Term] and may be terminated by either party with [Notice Period] notice; accounts already assigned remain with Agency through resolution unless recalled by Creditor.

---
Creditor: ______________________  Date: ____________
Agency: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Debt collection is heavily regulated (FDCPA in the US, plus many state-specific licensing requirements for collection agencies) — confirm the agency is properly licensed in every state where its debtors are located.*`,
  },
  {
    slug: "automobile-rental-agreement-template",
    name: "Automobile Rental Agreement",
    seoTitle: "Free Automobile Rental Agreement Template",
    description: "Free car rental agreement template for renting out a personal or fleet vehicle.",
    category: "Business",
    bodyMarkdown: `# Automobile Rental Agreement

**Owner/Renter (Lessor):** [Name]
**Driver (Lessee):** [Name, Driver's License #]
**Vehicle:** [Make/Model/Year, VIN, License Plate]
**Rental Period:** [Start Date/Time] – [End Date/Time]

## 1. Rental Fee
Total fee: [Amount], plus a security deposit of [Amount].

## 2. Mileage
[Included mileage, and per-mile overage fee, if applicable.]

## 3. Fuel
Vehicle is provided with [Fuel level] and must be returned with the same, or a refueling fee of [Amount] applies.

## 4. Driver Requirements
Driver must be at least [Age], hold a valid license, and [meet any additional requirements].

## 5. Insurance
[State whether Lessee's own auto insurance covers the rental, or whether a specific rental insurance/waiver is offered and its cost.]

## 6. Condition and Inspection
A condition inspection (noting any existing damage) is conducted at pickup and return.

## 7. Prohibited Uses
Vehicle may not be used for [racing, towing beyond capacity, illegal activity, subletting to another driver].

## 8. Damage and Late Return
Lessee is responsible for damage beyond normal wear, and a late fee of [Amount per hour/day] applies for late return.

---
Owner: ______________________  Date: ____________
Driver: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Confirm your own auto insurance actually covers renting your vehicle to others — personal policies often exclude this, requiring a commercial rider or separate rental-specific coverage.*`,
  },
  {
    slug: "redundancy-policy-template",
    name: "Redundancy Policy",
    seoTitle: "Free Redundancy Policy Template",
    description: "Free redundancy (layoff) policy template outlining the process and support for eliminating positions due to business need.",
    category: "HR",
    bodyMarkdown: `# Redundancy Policy

**Company:** [Company Name] · **Effective Date:** [Date]

## Purpose
This policy outlines [Company Name]'s approach when positions become redundant due to business, technological, or economic reasons — not due to individual performance.

## Selection Criteria
When redundancies affect multiple employees in a similar role, selection will be based on [objective criteria — e.g. skills matrix, length of service, business need] applied consistently and without discrimination.

## Consultation
Affected employees will be [notified and consulted] before a final decision, with an opportunity to discuss alternatives (redeployment, reduced hours) where feasible.

## Notice Period
Employees will receive [Notice Period] notice, or pay in lieu of notice, consistent with applicable law and their contract.

## Redundancy Pay
[Describe calculation, if offered beyond any statutory minimum — e.g. "[X] weeks' pay per year of service."]

## Support Offered
[Outplacement support, reference letters, extended benefits, if provided.]

## Appeals
Employees may appeal a redundancy decision by [Process] within [Timeframe].

---
Adopted by: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Redundancy/layoff law (required notice periods, consultation obligations, mass-layoff notification like the US WARN Act) varies significantly by country and by the number of employees affected — confirm your specific legal obligations before proceeding with any redundancy.*`,
  },
  {
    slug: "temporary-event-notice-template",
    name: "Temporary Event Notice",
    seoTitle: "Free Temporary Event Notice Template",
    description: "Free temporary event notice template for notifying local authorities of a one-off event requiring temporary permissions.",
    category: "Business",
    bodyMarkdown: `# Temporary Event Notice

**Applicant:** [Name/Organization]
**Event:** [Event Name]
**Date(s) and Times:** [Date(s), Start Time – End Time]
**Venue/Location:** [Address]

## Nature of Event
[Description — e.g. "outdoor community festival with food and beverage sales"]

## Activities Requiring Notice
[ ] Sale of alcohol  [ ] Live/recorded music  [ ] Food service  [ ] Late-night activity  [ ] Other: ___

## Expected Attendance
[Number]

## Safety and Noise Measures
[Steps taken to manage noise, crowd safety, and neighboring impact.]

## Applicant Declaration
I confirm the information above is accurate and that this event will be conducted in compliance with applicable local regulations.

Signature: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. "Temporary event notice" requirements (this term is used specifically in UK licensing law, but similar permits exist elsewhere) vary significantly by locality — check your specific local authority's required form, fee, and minimum notice period well before your event date.*`,
  },
  {
    slug: "affidavit-of-truth-template",
    name: "Affidavit of Truth",
    seoTitle: "Free Affidavit of Truth Template",
    description: "Free general affidavit of truth template — a sworn statement affirming that specific facts are true.",
    category: "Legal",
    bodyMarkdown: `# Affidavit of Truth

State of [State]
County of [County]

I, [Affiant Name], of [Address], being first duly sworn, depose and state that the following is true and correct to the best of my knowledge:
...
I make this statement freely and voluntarily, without duress, and understand that knowingly making a false statement herein may subject me to penalties for perjury.
...
*This document is provided for informational and educational purposes only and does not constitute legal advice. An affidavit only carries weight when it's genuinely truthful and properly notarized — it is a sworn legal document, not a formality, and false statements in one can carry real criminal consequences.*`,
  },
  {
    slug: "mileage-reimbursement-form-template",
    name: "Mileage Reimbursement Form",
    seoTitle: "Free Mileage Reimbursement Form Template",
    description: "Free mileage reimbursement form template for an employee claiming reimbursement for business use of their personal vehicle.",
    category: "Finance",
    bodyMarkdown: `# Mileage Reimbursement Form

**Employee:** [Name] · **Period:** [Start Date] – [End Date]

| Date | From | To | Purpose | Miles | Rate | Amount |
|------|------|----|---------|-------|------|--------|
| [Date] | [Location] | [Location] | [Purpose] | [Miles] | [Rate] | [Amount] |
| [Date] | [Location] | [Location] | [Purpose] | [Miles] | [Rate] | [Amount] |

**Total Miles:** [Number] · **Total Reimbursement: [Amount]**

## Reimbursement Rate
Using [Company rate / current IRS standard mileage rate] of [Amount] per mile.

## Approval
Employee signature: ______________________  Date: ____________
Manager approval: ______________________  Date: ____________

*Recording the specific business purpose for each trip (not just the mileage) is what actually makes this reimbursement compliant and audit-proof, both for the company and for the employee's own tax records.*`,
  },
  {
    slug: "task-order-template",
    name: "Task Order",
    seoTitle: "Free Task Order Template",
    description: "Free task order template — authorizes specific work under an existing master agreement or umbrella contract.",
    category: "Business",
    bodyMarkdown: `# Task Order

**Task Order #:** [Number] · **Date:** [Date]
**Issued under:** [Reference to the master/umbrella agreement and its date]
**Contractor:** [Name/Company]
**Client:** [Name/Company]

## 1. Scope of Work
Under the terms of the master agreement referenced above, Contractor will perform: [Specific task description for this order only].

## 2. Deliverables
[List specific deliverables for this task order.]

## 3. Period of Performance
Start date: [Date] · Completion date: [Date]

## 4. Price
Total price for this task order: [Amount], [fixed price / not-to-exceed hourly].

## 5. Governing Terms
All terms of the master agreement apply to this task order except as specifically modified here.

---
Client: ______________________  Date: ____________
Contractor: ______________________  Date: ____________

*A task-order structure lets you negotiate broad terms (liability, IP, payment terms) ONCE in a master agreement, then issue each new piece of work as a quick, simple task order — much faster than negotiating a full contract every time.*`,
  },
  {
    slug: "representation-agreement-template",
    name: "Representation Agreement",
    seoTitle: "Free Representation Agreement Template",
    description: "Free buyer's/tenant's representation agreement template — a real estate agent represents a buyer or tenant in a transaction.",
    category: "Real Estate",
    bodyMarkdown: `# Representation Agreement

**Client (Buyer/Tenant):** [Name]
**Agent/Broker:** [Name/Brokerage, License #]
**Date:** [Date]

## 1. Appointment
Client appoints Agent to represent Client's interests in [purchasing / leasing] property within [Criteria — location, price range, property type], for a term of [Duration].

## 2. Agent's Duties
Agent will act in Client's best interest, search for suitable properties, arrange showings, and assist with negotiations and closing.

## 3. Compensation
[Describe how Agent is paid — commonly a commission paid by the seller/landlord's side per local market convention, or, if not, describe Client's payment obligation directly.]

## 4. Exclusivity
[State whether this is an exclusive representation (Client works only with this Agent) or non-exclusive.]

## 5. Client's Obligations
Client will work in good faith with Agent during the term and disclose relevant preferences/constraints honestly.

## 6. Term and Termination
This Agreement runs for [Duration] and may be terminated by either party with [Notice Period] notice.

---
Client: ______________________  Date: ____________
Agent: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Buyer/tenant representation agreements and how agents are compensated are subject to real estate licensing law and, in the US, recent industry-wide changes (e.g. following the 2024 NAR settlement) — confirm current requirements in your state before signing or using one.*`,
  },
  {
    slug: "legal-disclaimer-template",
    name: "Legal Disclaimer",
    seoTitle: "Free Legal Disclaimer Template",
    description: "Free legal disclaimer template for a website, blog, or published content limiting liability for the information provided.",
    category: "Legal",
    bodyMarkdown: `# Legal Disclaimer

The information provided on [Website/Publication Name] (the "Site") is for general informational purposes only. All information is provided in good faith; however, we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability, or completeness of any information on the Site.

## Not Professional Advice
The Site does not provide [legal/financial/medical/professional] advice. Any information of that nature is for general informational purposes only, and you should consult an appropriately licensed professional before making decisions based on it.

## No Liability
Under no circumstance will [Company/Author Name] be liable for any loss or damage of any kind incurred as a result of using the Site or relying on any information provided.

## External Links
The Site may contain links to third-party websites. We do not warrant, endorse, or assume responsibility for the accuracy or reliability of any content on third-party sites.

## Changes
We may update this disclaimer from time to time without notice.

*A disclaimer helps set expectations and can reduce (though not eliminate) legal exposure — it works best paired with actually accurate content, not as a substitute for it.*`,
  },
  {
    slug: "intellectual-property-policy-template",
    name: "Intellectual Property Policy",
    seoTitle: "Free Intellectual Property Policy Template",
    description: "Free IP policy template establishing who owns work created by employees and contractors.",
    category: "Legal",
    bodyMarkdown: `# Intellectual Property Policy

**Company:** [Company Name] · **Effective Date:** [Date]

## Purpose
This policy clarifies ownership of intellectual property created by employees and contractors in connection with their work for [Company Name].

## Work-Related IP
Any invention, code, design, written work, or other IP created by an employee within the scope of their employment, using Company resources, or related to Company's business, belongs to [Company Name].

## Pre-Existing IP
IP an employee owned before joining, or created entirely outside the scope of their role using no Company resources, remains the employee's own property — employees should disclose any pre-existing IP they plan to use in their work.

## Contractors
All contractors sign a separate IP assignment agreement as part of their engagement, confirming Company ownership of work product created for Company.

## Disclosure Requirement
Employees must promptly disclose any invention or creative work related to Company's business, so ownership can be properly documented.

## Use of Third-Party IP
Employees may not use copyrighted material, patented technology, or trade secrets belonging to others without proper authorization.

---
Adopted by: ______________________  Date: ____________
Acknowledged by employee: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. "Work for hire" and employee-invention assignment rules vary by state/country (a few US states, like California, specifically protect certain employee inventions made entirely on personal time/resources) — confirm this policy is enforceable in your jurisdiction.*`,
  },
  {
    slug: "hipaa-authorization-form-template",
    name: "HIPAA Authorization Form",
    seoTitle: "Free HIPAA Authorization Form Template",
    description: "Free HIPAA authorization form template — a patient's written permission to release their health information to a specific third party.",
    category: "Legal",
    bodyMarkdown: `# Authorization for Release of Health Information

**Patient Name:** [Name] · **Date of Birth:** [Date]

I authorize [Healthcare Provider/Organization Name] to disclose the following health information:

## Information to Be Disclosed
[ ] Complete medical record  [ ] Specific records: ___ [describe — e.g. "visit notes from [Date range]"]

## Disclose To
Name: [Recipient Name/Organization]
Purpose: [e.g. "for treatment by a new provider," "for a disability claim," "personal request"]

## Expiration
This authorization expires on [Date], or upon [Event — e.g. "completion of the stated purpose"], whichever comes first, unless I revoke it sooner in writing.

## My Rights
I understand that:
- I may revoke this authorization in writing at any time, except to the extent action has already been taken in reliance on it.
- Information disclosed under this authorization may be subject to re-disclosure by the recipient and may no longer be protected by HIPAA once received.
- Signing this authorization is voluntary and is not a condition of receiving treatment (except as permitted by law).

---
Patient/personal representative signature: ______________________  Date: ____________
[If personal representative: relationship to patient]: [Relationship]

*This document is provided for informational and educational purposes only and does not constitute legal advice. HIPAA authorizations have specific required elements under 45 CFR 164.508 — a form missing any required element is not valid for disclosure purposes. Have your compliance officer or healthcare attorney confirm this form meets current requirements before using it in practice.*`,
  },
  {
    slug: "marital-settlement-agreement-template",
    name: "Marital Settlement Agreement",
    seoTitle: "Free Marital Settlement Agreement Template",
    description: "Free marital settlement agreement outline covering property division, support, and custody terms for a divorce. Each spouse should have independent legal counsel.",
    category: "Legal",
    bodyMarkdown: `# Marital Settlement Agreement

**Spouse A:** [Name]
**Spouse B:** [Name]
**Date:** [Date]

The parties, being married on [Marriage Date] and now separating/divorcing, agree to the following terms to resolve all issues arising from their marriage.

## 1. Property Division
**Spouse A receives:** [List assets — real estate, accounts, vehicles]
**Spouse B receives:** [List assets]

## 2. Debt Division
[How marital debts are allocated between the parties.]

## 3. Spousal Support
[ ] No spousal support requested by either party.
[ ] [Spouse] will pay [Amount] per [month] for [Duration], per [State] guidelines.

## 4. Child Custody and Support (if applicable)
[Reference a separate, detailed parenting plan; state child support amount per state guidelines.]

## 5. Health Insurance
[How health coverage is handled post-divorce, including any COBRA rights.]

## 6. Retirement Accounts
[Division of any retirement accounts, noting a QDRO (Qualified Domestic Relations Order) may be separately required to actually transfer retirement funds.]

## 7. Full Disclosure
Each party confirms they have fully and honestly disclosed all assets, debts, and income.

## 8. Independent Legal Counsel
Each party acknowledges they had the opportunity to review this Agreement with their own independent attorney.

---
Spouse A: ______________________  Date: ____________
Spouse B: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and is NOT a substitute for legal advice. Divorce settlements have significant, often irreversible financial and parental consequences, and courts require specific formats/disclosures that vary by state. EACH spouse should have their own family law attorney — one attorney cannot represent both sides, and an unrepresented spouse can later challenge an agreement as unfair.*`,
  },
  {
    slug: "loan-amortization-schedule-template",
    name: "Loan Amortization Schedule",
    seoTitle: "Free Loan Amortization Schedule Template",
    description: "Free loan amortization schedule template breaking down each payment into principal and interest over the life of a loan.",
    category: "Finance",
    bodyMarkdown: `# Loan Amortization Schedule

**Loan Amount:** [Amount] · **Interest Rate:** [Rate]% · **Term:** [Number] [months/years]
**Monthly Payment:** [Amount]

| Payment # | Date | Payment | Principal | Interest | Remaining Balance |
|-----------|------|---------|-----------|----------|-------------------------|
| 1 | [Date] | [Amount] | [Amount] | [Amount] | [Balance] |
| 2 | [Date] | [Amount] | [Amount] | [Amount] | [Balance] |
| ... | ... | ... | ... | ... | ... |
| [Final] | [Date] | [Amount] | [Amount] | [Amount] | $0.00 |

## Summary
Total payments: [Amount]
Total interest paid over the life of the loan: [Amount]

*Early payments in an amortized loan go mostly toward interest, with the principal portion growing over time — this is why paying even a little extra early in the loan term saves disproportionately more interest than the same extra payment made later.*`,
  },
  {
    slug: "key-employee-agreement-template",
    name: "Key Employee Agreement",
    seoTitle: "Free Key Employee Agreement Template",
    description: "Free key employee agreement template — special terms (retention, non-compete, severance) for an employee critical to the business.",
    category: "HR",
    bodyMarkdown: `# Key Employee Agreement
...
## 1. Role
Employee serves as [Title], a role the Company considers critical to its ongoing operations and value.

## 2. Compensation
Base salary: [Amount], plus [bonus/equity structure specific to this key role].

## 3. Retention Incentive (if applicable)
[Describe any retention bonus tied to remaining employed through a specific date or event, e.g. an acquisition.]

## 4. Confidentiality
Employee will keep Company's trade secrets and confidential information private, both during and after employment.

## 5. Non-Compete and Non-Solicitation
[Describe restrictions on competing or soliciting customers/employees after departure, within enforceability limits of your state.]

## 6. Severance
If Employee is terminated without cause, Employee will receive [Severance terms — e.g. "6 months' salary continuation"].

## 7. Key-Person Insurance (Company's option)
Company may, at its own expense, obtain key-person life/disability insurance on Employee; Employee agrees to cooperate with any required medical exam.

## 8. Term
[Fixed term or at-will, consistent with the Company's general employment practices.]

---
Company: ______________________  Date: ____________
Employee: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Non-compete enforceability varies significantly by state (several now ban them for most employees) — confirm current law before relying on that section, even for a genuinely critical employee.*`,
  },
  {
    slug: "change-of-control-agreement-template",
    name: "Change of Control Agreement",
    seoTitle: "Free Change of Control Agreement Template",
    description: "Free change of control agreement template — protects a key executive's compensation if the company is acquired or merges.",
    category: "Business",
    bodyMarkdown: `# Change of Control Agreement
...
A "Change of Control" occurs if: [Define — e.g. "a merger or sale of substantially all assets, or acquisition by a party of more than 50% of voting stock"].

## 2. Trigger Event
Benefits under this Agreement are triggered if, within [Period, e.g. "12 months"] after a Change of Control, Executive is terminated without cause or resigns for "good reason" (defined below).

## 3. Good Reason
"Good reason" includes: [e.g. material reduction in title/responsibilities, relocation beyond a specified distance, material reduction in compensation].

## 4. Benefits Upon Trigger
If triggered, Executive receives: [e.g. "[X] months' salary continuation, accelerated vesting of [%] of unvested equity, and continued health benefits for [Duration]"].

## 5. Excise Tax (if applicable, US)
[Note any provision addressing IRC Section 280G "golden parachute" excise tax treatment — cutback vs. gross-up — a significant negotiated term in real agreements.]

## 6. No Duty to Mitigate
[State whether Executive must seek other employment to reduce the benefit owed, or not.]

---
Company: ______________________  Date: ____________
Executive: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal, tax, or securities advice. Section 280G excise tax treatment specifically requires careful drafting and modeling — use a licensed executive compensation attorney for an actual agreement of this kind.*`,
  },
  {
    slug: "business-transfer-agreement-template",
    name: "Business Transfer Agreement",
    seoTitle: "Free Business Transfer Agreement Template",
    description: "Free business transfer agreement outline for selling an entire business as a going concern.",
    category: "Business",
    bodyMarkdown: `# Business Transfer Agreement
...
## 1. Sale of Business
Seller agrees to sell, and Buyer agrees to purchase, the business known as [Business Name], including: [Assets — inventory, equipment, goodwill, customer lists, contracts, intellectual property, as applicable].

## 2. Purchase Price
Total price: [Amount], paid: [Terms — e.g. "cash at closing" or "installments over ___"].

## 3. Excluded Assets/Liabilities
[List anything specifically NOT included — e.g. Seller's personal vehicle, or existing litigation liability that stays with Seller.]

## 4. Representations and Warranties
Seller represents that: financial statements provided are accurate, there is no undisclosed litigation, and all material contracts are disclosed.

## 5. Employees
[State whether Buyer will offer employment to existing staff, and on what terms.]

## 6. Non-Compete
Seller agrees not to compete with the business within [Territory] for [Duration] following the sale.

## 7. Closing
Closing will occur on [Date], subject to [any closing conditions — financing, due diligence completion, third-party consents].

## 8. Transition Assistance
[Describe any post-closing transition support Seller will provide — training, introductions to key clients.]

---
Seller: ______________________  Date: ____________
Buyer: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal, tax, or accounting advice. Selling an entire business involves complex due diligence, liability allocation, and tax structuring (asset sale vs. entity sale have very different tax consequences) — use a licensed M&A attorney and accountant for an actual sale.*`,
  },
  {
    slug: "standstill-agreement-template",
    name: "Standstill Agreement",
    seoTitle: "Free Standstill Agreement Template",
    description: "Free standstill agreement template — a party agrees to pause specific actions (like a lawsuit or acquisition attempt) for a defined period.",
    category: "Business",
    bodyMarkdown: `# Standstill Agreement
...
## 1. Standstill
For a period of [Duration] from the date above, [Party A] agrees not to: [Specific restricted actions — e.g. "acquire additional shares of Party B," "initiate or continue litigation regarding ___," "solicit Party B's employees or customers"].

## 2. Purpose
This standstill is intended to allow the parties to [negotiate a resolution / complete due diligence / pursue settlement discussions] without escalating actions during that time.

## 3. Exceptions
[Any carve-outs — e.g. "this does not prevent Party A from responding to a third-party offer" or "does not apply to routine business dealings unrelated to this matter."]

## 4. No Waiver of Rights
Except for the specific restrictions above, neither party waives any other rights or claims by entering this Agreement.

## 5. Expiration
This standstill automatically expires at the end of the period above unless extended in writing by both parties.
...
*This document is provided for informational and educational purposes only and does not constitute legal advice. Standstill agreements are common in M&A disputes, activist-investor situations, and pre-litigation negotiations — get the specific restricted actions defined narrowly and precisely, since ambiguity here is exactly what leads to a standstill being violated (intentionally or not).*`,
  },
  {
    slug: "contribution-agreement-template",
    name: "Contribution Agreement",
    seoTitle: "Free Contribution Agreement Template",
    description: "Free contribution agreement template — documents an owner or partner contributing cash, property, or services to a business.",
    category: "Finance",
    bodyMarkdown: `# Contribution Agreement
...
## 1. Contribution
[Contributing Party] agrees to contribute the following to [Company/Entity]: [Description — cash amount, property description, or services value].

## 2. Valuation
The contribution is valued at [Amount], as agreed by the parties [or per an independent appraisal, if property].

## 3. Consideration Received
In exchange, Contributing Party receives: [Equity/ownership % / units / membership interest — specify].

## 4. Representations
Contributing Party represents that they have clear title to any contributed property, free of liens, and the right to make this contribution.

## 5. Timing
The contribution will be made by [Date].

## 6. Tax Treatment
[Note that the tax treatment of a contribution — especially of appreciated property — can be complex; a professional should confirm before finalizing.]

---
Company: ______________________  Date: ____________
Contributing Party: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal or tax advice. Contributing property (rather than cash) in exchange for equity can trigger real tax consequences depending on the entity type and appreciation — confirm the tax treatment with an accountant before finalizing a non-cash contribution.*`,
  },
  {
    slug: "receivables-sale-agreement-template",
    name: "Receivables Sale Agreement (Invoice Factoring)",
    seoTitle: "Free Receivables Sale Agreement (Factoring) Template",
    description: "Free receivables sale (factoring) agreement outline — a business sells its unpaid invoices to a factor for immediate cash.",
    category: "Finance",
    bodyMarkdown: `# Receivables Sale Agreement (Factoring)
...
Seller agrees to sell, and Factor agrees to purchase, eligible accounts receivable as designated by Seller from time to time, subject to Factor's approval of each account debtor's creditworthiness.

## 2. Purchase Price
Factor will advance [%] of the face value of each approved invoice upon purchase, with the remaining balance (less the factoring fee) paid once the invoice is collected.

## 3. Factoring Fee
Fee: [%] of invoice value, [flat or increasing with time outstanding — specify].

## 4. Recourse
[ ] Non-recourse: Factor bears the loss if the account debtor fails to pay due to insolvency.
[ ] With recourse: Seller must buy back or replace any invoice not paid within [Number] days.

## 5. Notification to Debtors
[State whether account debtors are notified to pay Factor directly ("notification factoring") or Seller continues collecting and remits to Factor ("non-notification").]

## 6. Seller's Warranties
Seller warrants that each sold invoice is valid, for goods/services actually delivered, and not already pledged or sold elsewhere.

## 7. Term
This Agreement runs for [Term] and renews automatically unless either party gives [Notice Period] notice.

---
Seller: ______________________  Date: ____________
Factor: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal or financial advice. Recourse terms (Section 4) make a real difference to who bears the risk of a non-paying customer — read this section carefully, since "factoring" arrangements vary widely on exactly this point.*`,
  },
  {
    slug: "employee-confidentiality-agreement-template",
    name: "Employee Confidentiality Agreement",
    seoTitle: "Free Employee Confidentiality Agreement Template",
    description: "Free employee confidentiality agreement template — an ongoing obligation not to disclose the employer's trade secrets and confidential information.",
    category: "HR",
    bodyMarkdown: `# Employee Confidentiality Agreement
...
## 1. Confidential Information
"Confidential Information" includes trade secrets, customer lists, pricing, business plans, source code, and other non-public information Employee learns during employment.

## 2. Obligations
Employee will: keep Confidential Information private, use it only for Company's benefit while employed, and not disclose it to anyone outside the Company without authorization.

## 3. Duration
This obligation continues both during employment and indefinitely after it ends, for as long as the information remains genuinely confidential (not publicly known).

## 4. Return of Materials
Upon termination, Employee will return all Company documents, devices, and materials containing Confidential Information.

## 5. Exceptions
This Agreement does not restrict Employee from discussing their own wages, hours, or working conditions with coworkers, or from reporting suspected illegal activity to a government agency.

## 6. Remedies
Employee acknowledges that breach may cause irreparable harm, entitling Company to injunctive relief in addition to damages.

---
Company: ______________________  Date: ____________
Employee: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Section 5's carve-outs aren't optional extras — in the US, overly broad confidentiality language that could be read to prohibit discussing wages/working conditions has been found to violate the NLRA, even at non-union workplaces.*`,
  },
  {
    slug: "guarantee-agreement-template",
    name: "Guarantee Agreement",
    seoTitle: "Free Guarantee Agreement Template",
    description: "Free guarantee agreement template — a full contract where one party guarantees another's debt or performance obligation.",
    category: "Finance",
    bodyMarkdown: `# Guarantee Agreement

**Guarantor:** [Name]
**Beneficiary:** [Name]
**Principal Obligor:** [Name] (whose obligation is being guaranteed)
**Underlying Obligation:** [Reference — the loan, lease, or contract being guaranteed]
**Date:** [Date]

## 1. Guarantee
Guarantor unconditionally guarantees to Beneficiary the full and prompt payment/performance of Principal Obligor's obligations under the Underlying Obligation, up to a maximum of [Amount, if capped, or "the full amount owed"].

## 2. Nature of Guarantee
This is a [continuing / limited] guarantee. Beneficiary may demand payment directly from Guarantor without first exhausting remedies against Principal Obligor.

## 3. Term
This guarantee remains in effect until [the Underlying Obligation is fully satisfied / a specific date], unless released earlier in writing by Beneficiary.

## 4. Guarantor's Representations
Guarantor represents they have reviewed the Underlying Obligation and understand the extent of their liability under this guarantee.

## 5. Waiver
Guarantor waives notice of default by Principal Obligor as a condition of Beneficiary's right to demand payment from Guarantor, [unless otherwise required by law].
...
*This document is provided for informational and educational purposes only and does not constitute legal advice. Signing a personal guarantee makes the guarantor personally liable for someone else's debt — read the cap amount and waiver provisions closely, since these determine exactly how much exposure the guarantor is actually taking on.*`,
  },
  {
    slug: "personal-loan-application-template",
    name: "Personal Loan Application",
    seoTitle: "Free Personal Loan Application Template",
    description: "Free personal loan application form template for someone requesting a loan from a private lender or family member.",
    category: "Finance",
    bodyMarkdown: `# Personal Loan Application
...
Amount requested: [Amount]
Purpose: [Description]
Requested repayment period: [Duration]

## Applicant Information
Address: [Address] · Phone: [Phone] · Email: [Email]
Employer: [Name] · Monthly income: [Amount]

## Existing Debts
| Creditor | Monthly Payment | Balance |
|----------|--------------------|---------|
| [Creditor] | [Amount] | [Balance] |
...
## Proposed Repayment
[Proposed schedule — e.g. "$X per month starting [Date]"]

## Acknowledgment
I certify the above information is accurate. If approved, this loan will be documented in a signed promissory note.

Signature: ______________________  Date: ____________

*Using this application form before finalizing a personal loan — even between family — gives the lender real information to decide with, and sets up the expectation that a proper promissory note will follow if approved.*`,
  },
  {
    slug: "purchase-order-request-form-template",
    name: "Purchase Order Request Form",
    seoTitle: "Free Purchase Order Request Form Template",
    description: "Free purchase order request form — an internal request to have a formal purchase order issued to a vendor.",
    category: "Business",
    bodyMarkdown: `# Purchase Order Request Form

**Requested by:** [Name/Department] · **Date:** [Date]

## Vendor
Name: [Vendor Name] · Contact: [Contact Info]
...
## Delivery
Needed by: [Date] · Ship to: [Address/Location]

## Budget Code
[Code/account this should be charged to]

## Approval
Requested by: ______________________  Date: ____________
Approved by: ______________________  Date: ____________

*Once approved, this request triggers issuance of an actual numbered Purchase Order — keeping the request and the PO as separate documents preserves a clean approval trail even for routine purchases.*`,
  },
  {
    slug: "small-business-loan-application-template",
    name: "Small Business Loan Application",
    seoTitle: "Free Small Business Loan Application Template",
    description: "Free small business loan application checklist and form — the information a lender typically requests.",
    category: "Finance",
    bodyMarkdown: `# Small Business Loan Application

## Business Information
Business name: [Name] · Entity type: [LLC/Corp/Sole Prop]
Years in business: [Number] · Industry: [Industry]
EIN: [Number]

## Loan Request
Amount requested: [Amount]
Purpose: [e.g. equipment, working capital, expansion]
Requested term: [Duration]

## Financial Overview
Annual revenue: [Amount] · Monthly revenue (recent average): [Amount]
Existing business debt: [Amount]

## Owner Information
Owner name(s): [Name(s)] · Ownership %: [%]
Personal credit score range (if known): [Range]
...
*Gathering the supporting-documents checklist BEFORE applying (not scrambling after a lender asks) is what actually speeds up approval — most delays in small business lending come from back-and-forth document requests, not the underwriting itself.*`,
  },
  {
    slug: "doctors-note-template",
    name: "Doctor's Note",
    seoTitle: "Free Doctor's Note Template",
    description: "Free doctor's note template for excusing an absence from work or school for medical reasons.",
    category: "HR",
    bodyMarkdown: `# Doctor's Note

**[Medical Practice Name/Letterhead]**

Date: [Date]

This is to certify that [Patient Name] was seen at this office on [Visit Date] and, due to a medical condition, [is unable to attend work/school from [Start Date] to [End Date] / should be excused from [specific activity] until [Date]].

## Additional Notes (optional)
[Any accommodations recommended — e.g. "light duty," "no heavy lifting" — only what the patient/employer needs to know, not detailed diagnosis information.]
...
*This document must be issued by an actual licensed healthcare provider to be valid — it is not something an employee or student can complete themselves. Employers should keep any medical details confidential and generally shouldn't ask for more than what's needed to confirm the absence is legitimate.*`,
  },
  {
    slug: "sublease-termination-agreement-template",
    name: "Sublease Termination Agreement",
    seoTitle: "Free Sublease Termination Agreement Template",
    description: "Free sublease termination agreement template for ending a sublease arrangement before its scheduled end date.",
    category: "Real Estate",
    bodyMarkdown: `# Sublease Termination Agreement

**Sublessor:** [Name]
**Sublessee:** [Name]
**Property:** [Address]
**Original Sublease:** dated [Date]
**Termination Date:** [Date]

## 1. Early Termination
The parties agree to terminate the sublease referenced above effective [Termination Date], earlier than its original end date of [Original End Date].

## 2. Outstanding Rent/Fees
[State whether any rent is still owed through the termination date, and confirm payment.]

## 3. Security Deposit
[Describe how/when the security deposit will be returned, less any deductions.]

## 4. Move-Out
Sublessee will vacate the premises and return keys by [Date], leaving the property in the condition required by the original sublease.

## 5. Release
Upon satisfaction of the above, both parties release each other from further obligations under the sublease.

---
Sublessor: ______________________  Date: ____________
Sublessee: ______________________  Date: ____________

*Confirm the original tenant (Sublessor) has also cleared this early termination with the actual Landlord, if the original lease required Landlord's consent to sublet in the first place.*`,
  },
  {
    slug: "rental-pool-agreement-template",
    name: "Rental Pool Agreement",
    seoTitle: "Free Rental Pool Agreement Template",
    description: "Free rental pool agreement template — multiple property owners share bookings and revenue through a common management arrangement.",
    category: "Real Estate",
    bodyMarkdown: `# Rental Pool Agreement
...
## 1. Participation
Owner enrolls their unit in the rental pool managed by Manager, who will market and book the unit alongside other participating units.

## 2. Revenue Sharing
Rental revenue from the pool is distributed to participating owners based on: [Formula — e.g. "unit size and nights available," or "equal share regardless of individual unit bookings"].

## 3. Management Fee
Manager retains [%] of gross rental revenue as its management fee.

## 4. Owner's Use of the Unit
Owner may block out [Number] nights per year for personal use, with [Notice Period] advance notice to Manager.

## 5. Maintenance
[Who is responsible for routine maintenance, and how costs are shared or billed to the individual owner.]

## 6. Reporting
Manager provides Owner with [Frequency] statements showing pooled revenue, occupancy, and Owner's share.

## 7. Term and Withdrawal
[Term length and notice required for Owner to withdraw their unit from the pool.]

---
Manager: ______________________  Date: ____________
Owner: ______________________  Date: ____________

*Rental pools average out income across participating units — a slower unit still earns a share, and a top performer doesn't keep 100% of its own bookings — make sure the revenue-sharing formula genuinely reflects what owners were told before signing up.*`,
  },
  {
    slug: "landlord-reference-letter-template",
    name: "Landlord Reference Letter",
    seoTitle: "Free Landlord Reference Letter Template",
    description: "Free landlord reference letter template confirming a former tenant's rental history and payment record.",
    category: "Real Estate",
    bodyMarkdown: `# Landlord Reference Letter

[Date]

To Whom It May Concern,

This letter confirms that [Tenant Name] rented the property at [Address] from [Start Date] to [End Date].

## Rental History
Monthly rent: [Amount]
Payment history: [On time / describe any late payments factually]
Reason for leaving: [If known and appropriate to share]

## Property Condition
[Brief, factual note on how the unit was left, if relevant.]

## Would You Rent to Them Again?
[Optional, honest statement — e.g. "Yes, without reservation" — only include if genuinely true.]

---
Landlord/Property Manager: ______________________  Date: ____________
[Contact Information]

*Keep this factual and specific (payment history, condition at move-out) rather than a vague general endorsement — that's what actually helps a future landlord make a real decision, and it's more defensible if your honesty about a difficult tenant is ever questioned.*`,
  },
  {
    slug: "contingency-plan-template",
    name: "Contingency Plan",
    seoTitle: "Free Contingency Plan Template",
    description: "Free contingency plan template for preparing a backup approach if a primary plan or key assumption fails.",
    category: "Business",
    bodyMarkdown: `# Contingency Plan: [Project/Risk Area]

**Prepared by:** [Name] · **Date:** [Date]

## Primary Plan Assumption
[What the primary plan depends on — e.g. "key vendor delivers on schedule," "key employee remains available."]

## Trigger Event
[What specific event or warning sign would activate this contingency plan — be concrete, not vague.]

## Contingency Actions
| Step | Action | Owner | Timeline |
|------|--------|-------|----------|
| 1 | [Action] | [Name] | [Timeline] |
| 2 | [Action] | [Name] | [Timeline] |

## Resources Needed
[Budget, people, or tools needed to execute the contingency, ideally identified in advance.]

## Communication Plan
[Who needs to be told if this plan activates, and how quickly.]

## Decision Authority
[Who has the authority to declare the trigger event has occurred and activate this plan.]

*A contingency plan with a vague trigger ("if things go wrong") never actually gets activated in time — define the specific, observable event that starts it.*`,
  },
  {
    slug: "final-warning-before-dismissal-template",
    name: "Final Warning Before Dismissal",
    seoTitle: "Free Final Warning Before Dismissal Template",
    description: "Free final written warning template — the last documented step before termination in a progressive discipline process.",
    category: "HR",
    bodyMarkdown: `# Final Warning

**Employee:** [Name] · **Date:** [Date]
**Issued by:** [Manager Name]

## Prior Warnings
This is a final warning following: [Reference date(s) and nature of prior verbal/written warnings on this same issue].

## Continued Issue
[Specific, factual description of the ongoing performance or conduct problem, with dates.]

## Required Improvement
Employee must [specific, measurable expectation] by [Date].

## Consequence
**This is a final warning. Failure to meet the expectation above by the date specified will result in termination of employment.**
...
*This document is provided for informational and educational purposes only and does not constitute legal advice. Stating the consequence in unambiguous terms (as shown above) is what makes a subsequent termination defensible — vague language here undermines the whole progressive-discipline record.*`,
  },
  {
    slug: "new-hire-welcome-letter-template",
    name: "New Hire Welcome Letter",
    seoTitle: "Free New Hire Welcome Letter Template",
    description: "Free new hire welcome letter template — sent after the offer is accepted, ahead of their first day.",
    category: "HR",
    bodyMarkdown: `# Welcome Letter

Dear [Employee Name],

Welcome to [Company Name]! We're excited to have you join us as [Job Title], starting [Start Date].

## Before Your First Day
- [ ] Complete new hire paperwork: [Link/instructions]
- [ ] [Any equipment/account setup steps]

## Your First Day
Arrive at: [Time] · Location: [Address/remote link]
Please bring: [ID, other required items]
You'll meet with: [Manager/HR Name]

## What to Expect
[Brief overview of onboarding — first week schedule, who they'll meet, initial focus areas.]

## Questions?
Contact [HR/Manager Name] at [Email/Phone] anytime before your start date.

We're looking forward to working with you!

[Name, Title]

*A welcome letter that includes concrete first-day logistics (not just enthusiasm) reduces new-hire anxiety more than a purely celebratory message — people want to know exactly what to expect.*`,
  },
  {
    slug: "letter-of-acceptance-of-resignation-template",
    name: "Letter of Acceptance of Resignation",
    seoTitle: "Free Letter of Acceptance of Resignation Template",
    description: "Free letter template for an employer formally acknowledging and accepting an employee's resignation.",
    category: "HR",
    bodyMarkdown: `# Acceptance of Resignation

[Date]

Dear [Employee Name],

This letter confirms receipt and acceptance of your resignation from the position of [Job Title], effective [Last Working Day], as communicated on [Date resignation was submitted].

## Transition Details
Your last working day will be [Date]. [Any details on handover expectations, final pay, or exit interview scheduling.]

## Final Pay and Benefits
Your final paycheck, including [accrued PTO], will be processed per standard company timing and [State] requirements.

We appreciate your contributions during your time here and wish you well in your next role.

Sincerely,
[Name, Title]
[Company Name]

*A prompt written acceptance closes the loop clearly for both sides — it confirms the exact last day agreed to, which matters if there's ever a dispute about final pay timing.*`,
  },
  {
    slug: "investor-relations-agreement-template",
    name: "Investor Relations Agreement",
    seoTitle: "Free Investor Relations Agreement Template",
    description: "Free investor relations agreement template for a company engaging an IR consultant or firm.",
    category: "Business",
    bodyMarkdown: `# Investor Relations Agreement

**Company:** [Company Name]
**IR Consultant/Firm:** [Name]
**Effective Date:** [Date]

## 1. Services
Consultant will provide investor relations services, including: [e.g. drafting shareholder communications, coordinating earnings calls, managing analyst relationships, media outreach].

## 2. Compensation
[Monthly retainer of [Amount] / project fee — specify]. [State clearly whether any compensation is tied to stock price or trading volume, which raises securities-law concerns and should generally be avoided.]

## 3. Compliance
Consultant will comply with applicable securities disclosure laws (e.g. Regulation FD in the US) and will not disclose material non-public information without authorization.

## 4. Disclosure of Compensation
[If required by law, e.g. under Section 17(b) of the Securities Act for promotional activities: Consultant will disclose any compensation received when discussing the Company publicly.]
...
*This document is provided for informational and educational purposes only and does not constitute legal advice. IR compensation structures tied to stock promotion have specific SEC disclosure requirements, and "pump and dump" schemes using paid stock promotion are a real enforcement priority — avoid any compensation tied to share price movement, and use a licensed securities attorney to review this relationship.*`,
  },
  {
    slug: "reservation-policy-template",
    name: "Reservation Policy",
    seoTitle: "Free Reservation Policy Template",
    description: "Free reservation policy template for a restaurant, venue, or service business — booking, deposit, and no-show terms.",
    category: "Business",
    bodyMarkdown: `# Reservation Policy

**Business Name:** [Name] · **Effective Date:** [Date]

## Making a Reservation
Reservations can be made [Online/phone/in-person], up to [Timeframe] in advance.

## Deposits
[ ] No deposit required for standard reservations.
[ ] A deposit of [Amount] is required for [group size/special events], applied toward your bill.

## Cancellation Policy
Cancellations made [Timeframe] before your reservation receive a full refund of any deposit. Cancellations after that, or no-shows, [forfeit the deposit / are charged a fee of [Amount]].

## Late Arrivals
Reservations are held for [Number] minutes past the booked time before being released.

## Party Size Changes
Please notify us of any changes to your party size at least [Timeframe] in advance.

## Contact
Questions about your reservation: [Phone/Email]

*A clear no-show policy protects revenue on your most valuable time slots — but pairing it with a genuine grace period and easy modification process keeps it from feeling punitive to good-faith customers.*`,
  },
  {
    slug: "expenses-policy-template",
    name: "Expenses Policy",
    seoTitle: "Free Employee Expenses Policy Template",
    description: "Free employee expenses policy template covering what's reimbursable and how to submit expense claims.",
    category: "HR",
    bodyMarkdown: `# Employee Expenses Policy

**Company:** [Company Name] · **Effective Date:** [Date]

## What's Reimbursable
[List categories — e.g. business travel, client meals, approved software/tools, mileage for business use of a personal vehicle.]

## What's Not Reimbursable
[e.g. personal entertainment, alcohol beyond a reasonable client-meal context, first-class travel without prior approval.]

## Approval
Expenses over [Amount] require pre-approval from [Manager/Finance] before being incurred.

## Submission Process
Submit expense claims via [System/process] within [Number] days of incurring the expense, with itemized receipts for anything over [Amount].

## Reimbursement Timeline
Approved expenses are reimbursed within [Number] days, via [Method — payroll, direct deposit].

## Corporate Card (if applicable)
[Rules for corporate card use, and consequences for personal charges.]

*Requiring itemized receipts (not just a credit card statement line) is what actually lets finance verify an expense was legitimate and correctly categorized for tax purposes.*`,
  },
  {
    slug: "investment-policy-template",
    name: "Investment Policy Statement",
    seoTitle: "Free Investment Policy Statement Template",
    description: "Free investment policy statement template — documents an organization's or individual's investment goals, risk tolerance, and guidelines.",
    category: "Finance",
    bodyMarkdown: `# Investment Policy Statement

**Prepared for:** [Individual/Organization Name] · **Date:** [Date]

## Investment Objectives
[e.g. "capital preservation with modest growth" or "long-term growth to fund a specific liability, such as a pension obligation."]

## Time Horizon
[How long until the funds are needed — this drives the appropriate risk level.]

## Risk Tolerance
[Description of acceptable volatility/drawdown — conservative, moderate, or aggressive.]

## Asset Allocation Targets
| Asset Class | Target % | Range |
|-----------------|----------|-------|
| [e.g. Equities] | [%] | [Range] |
| [e.g. Fixed Income] | [%] | [Range] |
| [e.g. Cash] | [%] | [Range] |

## Rebalancing
The portfolio will be rebalanced [Frequency, or "when any asset class drifts more than X% from target"].

## Prohibited Investments (if any)
[e.g. no individual stock concentration above X%, no uncovered options, no investments in specific excluded sectors.]

## Review
This statement will be reviewed [Frequency] or upon a material change in objectives.

---
Approved by: ______________________  Date: ____________

*An investment policy statement's real value is discipline — having predefined allocation ranges and a rebalancing rule keeps decisions from being made emotionally during a market swing.*`,
  },
  {
    slug: "request-for-qualification-template",
    name: "Request for Qualification (RFQ)",
    seoTitle: "Free Request for Qualification (RFQ) Template",
    description: "Free request for qualification template — pre-screens vendors' credentials and experience before inviting full proposals.",
    category: "Business",
    bodyMarkdown: `# Request for Qualification (RFQ)

**Issued by:** [Organization Name]
**Project:** [Description] · **Date:** [Date]

## Purpose
[Organization Name] is seeking qualified firms for [Project/type of work]. This RFQ is used to shortlist qualified candidates before requesting full proposals.

## Required Qualifications
- [Requirement — e.g. minimum years of relevant experience]
- [Requirement — e.g. specific licenses/certifications]
- [Requirement — e.g. bonding/insurance capacity]

## Submission Requirements
Interested firms should submit:
- Company overview and relevant experience
- Key personnel qualifications
- References from at least [Number] similar projects
- Financial capacity statement (if applicable)
...
## Timeline
Submission deadline: [Date] · Shortlist announced: [Date]

Contact: [Name, Email]

*An RFQ filters for capability before anyone invests time in a detailed proposal — use it when the field of potential vendors is large or unfamiliar, and skip straight to an RFP when you already know who's qualified.*`,
  },
  {
    slug: "procurement-policy-template",
    name: "Procurement Policy",
    seoTitle: "Free Procurement Policy Template",
    description: "Free procurement policy template establishing how a company sources, approves, and purchases goods and services.",
    category: "Business",
    bodyMarkdown: `# Procurement Policy

**Company:** [Company Name] · **Effective Date:** [Date]

## Purpose
This policy ensures purchases are made cost-effectively, ethically, and with appropriate approval.

## Approval Thresholds
| Purchase Amount | Required Approval |
|---------------------|------------------------|
| Under [Amount] | Department manager |
| [Amount] – [Amount] | Department head + Finance |
| Over [Amount] | Executive/CFO approval, competitive bids required |

## Competitive Bidding
Purchases over [Amount] require at least [Number] competitive quotes, unless a sole-source justification is documented.

## Preferred Vendors
[If applicable: list of pre-approved vendors and when they must be used vs. when alternatives can be sought.]

## Conflicts of Interest
Employees must disclose any personal or financial relationship with a vendor being considered for a purchase.

## Purchase Orders
All purchases over [Amount] require a formal purchase order before the vendor is engaged.

## Record-Keeping
[Requirements for retaining quotes, POs, and invoices for audit purposes.]

---
Adopted by: ______________________  Date: ____________

*Setting a real competitive-bid threshold (not just "get quotes when convenient") is what actually controls costs on larger purchases — and it protects the person approving them if a purchase is ever questioned.*`,
  },
  {
    slug: "change-of-address-letter-template",
    name: "Change of Address Letter",
    seoTitle: "Free Change of Address Letter Template",
    description: "Free change of address letter template for notifying contacts, vendors, or institutions of a new address.",
    category: "Business",
    bodyMarkdown: `# Change of Address Notification

[Date]

Dear [Recipient Name],

Please be advised that, effective [Date], [my/our] address has changed to:
...
Please update your records accordingly. [If applicable: "Please redirect all future correspondence, invoices, and deliveries to the new address."]
...
*Sending this to your full list of banks, vendors, subscriptions, and government agencies at once (rather than one at a time as issues come up) avoids missed mail and payment notices during a move.*`,
  },
  {
    slug: "apology-letter-template",
    name: "Apology Letter",
    seoTitle: "Free Business Apology Letter Template",
    description: "Free business apology letter template for addressing a mistake or service failure with a customer or client.",
    category: "Business",
    bodyMarkdown: `# Apology Letter

[Date]

Dear [Recipient Name],

I want to personally apologize for [specific issue — a service failure, delay, error]. I understand this [caused inconvenience/impacted your business/fell short of what you expect from us], and I take full responsibility.

## What Happened
[Brief, honest explanation — not excessive detail or excuses.]

## What We're Doing About It
[Specific corrective action already taken, and/or steps to prevent recurrence.]

## Making It Right
[If applicable: a specific remedy — refund, credit, replacement, or other gesture.]

I appreciate your patience and value our relationship. Please don't hesitate to reach out directly if there's anything else I can do.

Sincerely,
[Your Name]
[Direct Contact Information]

*An apology that names the specific issue and offers a concrete remedy — rather than a vague "sorry for any inconvenience" — is what actually rebuilds trust after a mistake.*`,
  },
  {
    slug: "shipping-policy-template",
    name: "Shipping Policy",
    seoTitle: "Free Shipping Policy Template",
    description: "Free shipping policy template for an online store — processing times, costs, and delivery terms.",
    category: "Legal",
    bodyMarkdown: `# Shipping Policy

**Effective Date:** [Date]

## Processing Time
Orders are processed within [Number] business days before shipping. Orders placed on weekends/holidays are processed the next business day.

## Shipping Methods and Costs
| Method | Estimated Delivery | Cost |
|--------|------------------------|------|
| [Standard] | [Days] | [Amount / "Free over $X"] |
| [Expedited] | [Days] | [Amount] |

## Shipping Destinations
We currently ship to: [Countries/regions]. [Note any restrictions.]

## Order Tracking
You'll receive a tracking number via email once your order ships.

## Delays
[Company Name] is not responsible for delays caused by the carrier, customs, or events outside our control, though we'll help track down a lost shipment.

## Lost or Damaged Packages
[Process for reporting and resolving lost/damaged shipments.]

## International Orders
[Note on customs duties/taxes being the responsibility of the buyer, if applicable.]

*Setting realistic processing/delivery estimates (and clearly separating them) is what actually reduces "where is my order" support tickets — customers plan around the total, so be conservative with both numbers.*`,
  },
  {
    slug: "notice-of-annual-general-meeting-template",
    name: "Notice of Annual General Meeting",
    seoTitle: "Free Notice of Annual General Meeting (AGM) Template",
    description: "Free notice of AGM template for formally calling a company's or organization's annual shareholder/member meeting.",
    category: "Business",
    bodyMarkdown: `# Notice of Annual General Meeting

**[Company/Organization Name]**

Notice is hereby given that the Annual General Meeting will be held on [Date], at [Time], at [Location / virtual meeting link].

## Agenda
1. Approval of minutes from the previous AGM
2. [Chairman's/CEO's report]
3. [Approval of annual financial statements]
4. [Election of directors/officers, if applicable]
5. [Other business items]

## Eligibility to Vote
[Who is entitled to vote — e.g. "shareholders of record as of [Date]"]

## Proxy Voting
Shareholders/members unable to attend may vote by proxy. Proxy forms must be submitted by [Date] to [Address/Email].

## Documents Available
[Annual report, financial statements, and other documents are available for review at [Location/link].]
...
*Meeting the required notice PERIOD (commonly 14-21 days minimum, varying by jurisdiction and bylaws) matters legally — a meeting called with insufficient notice can have its resolutions challenged.*`,
  },
  {
    slug: "schedule-of-real-estate-owned-template",
    name: "Schedule of Real Estate Owned (REO)",
    seoTitle: "Free Schedule of Real Estate Owned Template",
    description: "Free schedule of real estate owned template — lists all properties an individual or entity owns, often required for a loan application.",
    category: "Finance",
    bodyMarkdown: `# Schedule of Real Estate Owned

**Prepared by:** [Name] · **Date:** [Date]

| Property Address | Type (Primary/Rental/Investment) | Market Value | Mortgage Balance | Monthly Payment | Monthly Rental Income (if applicable) |
|--------------------|-----------------------------------------|------------------|------------------------|----------------------|--------------------------------------------|
| [Address] | [Type] | [Value] | [Balance] | [Payment] | [Income] |
| [Address] | [Type] | [Value] | [Balance] | [Payment] | [Income] |
...
Total net equity: [Amount]

---
Certified accurate by: ______________________  Date: ____________

*Lenders use this schedule to assess total debt exposure across all your properties — be precise about rental income figures, since they directly affect how much additional financing you may qualify for.*`,
  },
  {
    slug: "heads-of-agreement-template",
    name: "Heads of Agreement",
    seoTitle: "Free Heads of Agreement Template",
    description: "Free heads of agreement template — a preliminary, largely non-binding outline of key deal terms before a full contract is drafted.",
    category: "Business",
    bodyMarkdown: `# Heads of Agreement

**Party A:** [Name]
**Party B:** [Name]
**Date:** [Date]

This Heads of Agreement sets out the key terms the parties have agreed in principle for [Transaction Description], to be formalized in a definitive agreement.

## Key Terms
1. [Term — e.g. purchase price/valuation]
2. [Term — e.g. structure of the deal]
3. [Term — e.g. key conditions to close]
4. [Term — e.g. timeline]

## Binding Provisions
The parties intend Sections [X] (confidentiality) and [Y] (exclusivity, if included) to be legally binding. All other provisions are a statement of intent only and not legally binding until a definitive agreement is signed.

## Due Diligence
Each party will have [Number] days to complete due diligence.

## Next Steps
The parties will work in good faith to negotiate and execute a definitive agreement reflecting these terms by [Target Date].

---
Party A: ______________________  Date: ____________
Party B: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. "Heads of agreement" (common in UK/Commonwealth M&A practice) serves the same function as a US-style Letter of Intent — be explicit about which sections are actually binding, since ambiguity here has led to real litigation over whether a "preliminary" document was enforceable.*`,
  },
  {
    slug: "information-security-policy-template",
    name: "Information Security Policy",
    seoTitle: "Free Information Security Policy Template",
    description: "Free information security policy template — an organization-wide policy covering data protection, access control, and incident response.",
    category: "Legal",
    bodyMarkdown: `# Information Security Policy
...
*This document is provided for informational and educational purposes only and does not constitute legal advice. If you handle EU personal data, healthcare data, or payment card data, this general policy needs to align with the specific technical requirements of GDPR, HIPAA, or PCI-DSS respectively — those frameworks require more than this outline alone.*`,
  ...
  {
    slug: "final-waiver-of-lien-template",
    name: "Final Waiver of Lien",
    seoTitle: "Free Final Waiver of Lien Template",
    description: "Free final waiver of lien template — a contractor confirms full and final payment received, waiving all lien rights on the project.",
    category: "Real Estate",
    bodyMarkdown: `# Final Waiver and Release of Lien
...
Upon receipt of final payment in the amount of [Amount], Claimant waives and releases any and all lien or claim of lien against the property described above, for all labor, materials, and services provided in connection with the entire project, through and including [Date].

## Certification
Claimant certifies that:
1. All subcontractors and suppliers used by Claimant on this project have been paid in full.
2. This waiver is unconditional and covers the FULL and FINAL amount owed — no partial or progress payment.

---
Claimant signature: ______________________  Date: ____________
[Notarization block, if required in your state]

*This document is provided for informational and educational purposes only and does not constitute legal advice. Unlike a conditional or partial waiver (used for progress payments), a FINAL waiver should only be signed after payment has actually cleared — signing it before funds are confirmed can permanently waive lien rights even if the check later bounces, depending on your state's law.*`,
  },
  {
    slug: "announcement-to-customers-policy-change-template",
    name: "Announcement to Customers (Policy Change)",
    seoTitle: "Free Customer Announcement Letter Template (Policy Change)",
    description: "Free customer announcement letter template for informing customers of a policy, pricing, or service change.",
    category: "Business",
    bodyMarkdown: `# Announcement to Customers: [Policy/Change Name]

[Date]

Dear [Customer Name/Valued Customer],

We're writing to let you know about an upcoming change to [policy/pricing/service], effective [Date].

## What's Changing
[Describe the change clearly and specifically.]

## Why We're Making This Change
[Brief, honest reason — builds more trust than a vague corporate explanation.]

## What This Means for You
[How it affects the customer specifically — any action needed on their part.]

## Questions?
If you have any questions, please contact us at [Email/Phone]. We appreciate your continued business.

Sincerely,
[Your Name/Company]

*Giving customers real advance notice (not a same-day surprise) for changes that affect their costs or experience — even when not legally required — is what keeps a policy change from feeling like a bait-and-switch.*`,
  },
  {
    slug: "artist-recording-contract-template",
    name: "Artist Recording Contract",
    seoTitle: "Free Artist Recording Contract Template",
    description: "Free recording contract template between a record label/producer and a music artist.",
    category: "Business",
    bodyMarkdown: `# Recording Contract
...
Artist agrees to record [Number] albums/tracks for Label during the term of this Agreement.

## 2. Advance
Label will pay Artist an advance of [Amount], recoupable against future royalties.

## 3. Royalties
Artist will receive [%] of [net receipts / retail price], calculated after recoupment of the advance and recording costs.

## 4. Ownership of Masters
[State who owns the recorded masters — commonly the Label, with the Artist earning royalties, though "artist-owned masters" deals are increasingly negotiated.]

## 5. Term
This Agreement runs for [Term], with [Label's option to extend for additional albums, if applicable].

## 6. Promotion
Label will [describe promotional commitment, if any — this is often heavily negotiated and worth being specific about].

## 7. Termination
[Grounds for either party to terminate, and what happens to unreleased recordings.]

---
Label: ______________________  Date: ____________
Artist: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Recording contract terms (ownership of masters, royalty calculation method, recoupment terms) vary enormously and are heavily negotiated in the real music industry — have a licensed entertainment attorney review before signing an actual deal.*`,
  },
  {
    slug: "asset-depreciation-schedule-template",
    name: "Asset Depreciation Schedule",
    seoTitle: "Free Asset Depreciation Schedule Template",
    description: "Free asset depreciation schedule template tracking the declining book value of business assets over time.",
    category: "Finance",
    bodyMarkdown: `# Asset Depreciation Schedule

**As of:** [Date]

| Asset | Purchase Date | Cost | Useful Life | Method | Annual Depreciation | Accumulated Depreciation | Current Book Value |
|-------|-----------------|------|-----------------|--------|--------------------------|------------------------------|--------------------------|
| [Asset] | [Date] | [Amount] | [Years] | [Straight-line/Other] | [Amount] | [Amount] | [Amount] |
| [Asset] | [Date] | [Amount] | [Years] | [Method] | [Amount] | [Amount] | [Amount] |

## Total Fixed Assets
Total cost: [Amount] · Total accumulated depreciation: [Amount] · **Total net book value: [Amount]**

*Depreciation method and useful life assumptions affect both your reported profit and your tax liability — confirm the method used matches what your tax jurisdiction allows or requires for the asset category.*`,
  },
  {
    slug: "food-and-drink-policy-template",
    name: "Food and Drink Policy",
    seoTitle: "Free Workplace Food and Drink Policy Template",
    description: "Free food and drink policy template for a workplace — rules for eating, drinks, and kitchen/break area use.",
    category: "HR",
    bodyMarkdown: `# Food and Drink Policy

**Company:** [Company Name] · **Effective Date:** [Date]

## Purpose
This policy keeps shared spaces clean and safe while accommodating employees' need to eat and drink during the workday.

## Where Food Is Permitted
[e.g. break room, designated desk areas — not near sensitive equipment.]

## Kitchen/Break Area Rules
- Clean up after yourself, including dishes and spills
- Label and date items stored in shared refrigerators
- Items left unlabeled for more than [X days] may be discarded
- [Any equipment usage rules — microwave, coffee machine]

## Allergies and Shared Spaces
[Note any specific accommodations — e.g. a nut-free zone — if relevant to your workplace.]

## Alcohol (if applicable)
[Your specific policy on alcohol at work events or in the office.]

## Enforcement
[Consequence for repeated policy violations, if any — usually a reminder rather than formal discipline.]

*A simple, consistently enforced rule (like a Friday refrigerator clean-out) prevents this from becoming a recurring source of office friction — the policy matters less than actually following it.*`,
  },
  {
    slug: "request-for-raise-template",
    name: "Request for Raise",
    seoTitle: "Free Request for Raise Letter Template",
    description: "Free request for raise template — an employee formally asks their manager for a salary increase.",
    category: "HR",
    bodyMarkdown: `# Request for Salary Increase

[Date]

Dear [Manager Name],

I'm writing to formally request a review of my current salary.

## My Contributions
[Specific accomplishments and impact since your last review — numbers and results, not just effort.]

## Market Context (if relevant)
[Optional: if you have researched comparable market rates for your role, mention it factually.]

## What I'm Requesting
I would like to request an increase to [Amount/percentage], effective [Date, if you have one in mind].
...
*Leading with specific, quantified contributions (not just tenure or effort) is what actually makes a raise request persuasive — "I've been here 2 years" is much weaker than "I closed $X in new business" or "I reduced processing time by X%."*`,
  },
  {
    slug: "trespass-notice-template",
    name: "Trespass Notice",
    seoTitle: "Free Trespass Notice Template",
    description: "Free trespass notice template — formally bars a specific person from a property, commonly used before pursuing a trespassing charge.",
    category: "Legal",
    bodyMarkdown: `# Notice of Trespass
...
**RE: Notice Against Trespass — [Property Address]**

You are hereby notified that you are no longer permitted on the property located at [Property Address], effective immediately.

## Reason
[Brief, factual reason, if you choose to state one — not required in most jurisdictions, but can help if the notice is later challenged.]

## Consequences of Violation
If you enter this property after receiving this notice, you may be subject to arrest and prosecution for criminal trespass under applicable law.

## Duration
This notice remains in effect [indefinitely / until [Date] / until revoked in writing by the undersigned].

---
Issued by: ______________________  Date: ____________
[Name, Title]

*This document is provided for informational and educational purposes only and does not constitute legal advice. For this notice to actually support a future trespassing charge, most jurisdictions require proof the person received it — deliver in person with a witness, or by a method that creates a delivery record (certified mail), and keep a copy.*`,
  },
  {
    slug: "sellers-property-disclosure-statement-template",
    name: "Seller's Property Disclosure Statement",
    seoTitle: "Free Seller's Property Disclosure Statement Template",
    description: "Free seller's property disclosure statement template — discloses known material defects and conditions before a real estate sale.",
    category: "Real Estate",
    bodyMarkdown: `# Seller's Property Disclosure Statement

**Property Address:** [Address]
**Seller(s):** [Name(s)]
**Date:** [Date]

Seller discloses the following known information about the property's condition, to the best of Seller's knowledge. This is not a warranty of condition.

## Structural
Known foundation issues: [Yes/No, describe]
Known roof issues: [Yes/No, describe, and roof age if known]

## Systems
Plumbing issues: [Yes/No, describe]
Electrical issues: [Yes/No, describe]
HVAC condition/age: [Describe]

## Water and Environmental
Flooding/water intrusion history: [Yes/No, describe]
Known mold issues: [Yes/No, describe]
Known lead paint (pre-1978 homes, US): [Yes/No — see separate required lead disclosure]
Known asbestos, radon, or other environmental hazards: [Yes/No, describe]

## Pest History
Known termite/pest infestation history: [Yes/No, describe]

## Legal/Title
Known boundary disputes, easements, or liens not otherwise disclosed: [Yes/No, describe]
Known HOA violations or pending assessments: [Yes/No, describe]

## Other Material Defects
[Anything else a reasonable buyer would want to know.]

---
Seller signature: ______________________  Date: ____________
Buyer acknowledgment of receipt: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Most US states legally REQUIRE a property disclosure using a specific state-mandated form (not a generic one), and knowingly omitting a known material defect can expose a seller to real liability after closing — use your state's official disclosure form, not this general template, for an actual sale.*`,
  },
  {
    slug: "patient-referral-form-template",
    name: "Patient Referral Form",
    seoTitle: "Free Patient Referral Form Template",
    description: "Free patient referral form template for one healthcare provider referring a patient to another for specialized care.",
    category: "Business",
    bodyMarkdown: `# Patient Referral Form

**Referring Provider:** [Name, Practice] · **Date:** [Date]
**Referred To:** [Specialist Name/Practice]

## Patient Information
Name: [Name] · DOB: [Date] · Contact: [Phone]

## Reason for Referral
[Clinical reason/diagnosis prompting the referral]

## Relevant History
[Brief relevant medical history, current medications, prior test results relevant to this referral]

## Requested
[ ] Consultation only  [ ] Consultation and treatment  [ ] Second opinion

## Attachments
[ ] Relevant test results  [ ] Imaging  [ ] Prior notes

---
Referring provider signature: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute medical advice. Patient information shared via referral is protected health information — send it through a secure, HIPAA-compliant channel, not a plain unencrypted email or fax without proper safeguards.*`,
  },
  {
    slug: "progress-payment-invoice-template",
    name: "Progress Payment Invoice",
    seoTitle: "Free Progress Payment Invoice Template",
    description: "Free progress payment invoice template for billing a percentage of a project as work is completed, common in construction.",
    category: "Finance",
    bodyMarkdown: `# Progress Payment Invoice
...
| Line Item | Contract Value | % Complete | Amount Earned to Date |
|-----------|-------------------|-----------------|-----------------------------|
| [Item] | [Amount] | [%] | [Amount] |
| [Item] | [Amount] | [%] | [Amount] |
...
## Payment Terms
Due [Terms, e.g. Net 30]

---
Approved by (if required before payment): ______________________  Date: ____________

*Tracking "previously billed" and retainage separately (not just billing the current period in isolation) is what keeps a multi-invoice construction project's math auditable from start to finish.*`,
  },
  {
    slug: "irrevocable-standby-letter-of-credit-template",
    name: "Irrevocable Standby Letter of Credit",
    seoTitle: "Free Irrevocable Standby Letter of Credit Template",
    description: "Free standby letter of credit outline — a bank's commitment to pay a beneficiary if the applicant fails to perform an obligation.",
    category: "Finance",
    bodyMarkdown: `# Irrevocable Standby Letter of Credit (Outline)
...
## 1. Undertaking
[Issuing Bank] hereby establishes this irrevocable standby letter of credit in favor of Beneficiary, in the amount of [Amount], available upon Beneficiary's presentation of a compliant drawing request stating that Applicant has failed to perform under [Reference the underlying contract].

## 2. Drawing Conditions
Beneficiary may draw on this credit by presenting: [Required documents — e.g. a signed statement of default and a copy of the underlying contract].

## 3. Partial Draws
[State whether partial drawdowns are permitted.]

## 4. Expiration
This letter of credit expires on [Date] unless drawn upon before that date.

## 5. Governing Rules
This letter of credit is subject to [ICC Uniform Customs and Practice for Documentary Credits (UCP 600), or applicable local law].

---
Issued by: [Bank Name]

*This document is provided for informational and educational purposes only — a real standby letter of credit must be issued and signed by a bank, not drafted independently by the applicant or beneficiary. This outline shows the structure so a business knows what to expect and negotiate when requesting one from its bank.*`,
  },
  {
    slug: "merchant-card-processing-application-template",
    name: "Merchant Card Processing Application",
    seoTitle: "Free Merchant Card Processing Application Template",
    description: "Free merchant card processing application — the information a payment processor typically requests to set up a new merchant account.",
    category: "Finance",
    bodyMarkdown: `# Merchant Card Processing Application

## Business Information
Legal business name: [Name] · DBA (if different): [Name]
Business address: [Address] · Tax ID/EIN: [Number]
Business type: [Retail/E-commerce/Service/etc.]
Years in business: [Number]

## Processing Details
Estimated monthly card volume: [Amount]
Average transaction size: [Amount]
Card-present or card-not-present: [Type]

## Bank Information
Bank name: [Name] · Account for deposits: [Attach securely, do not include full account number in this form]

## Ownership
Owner name(s): [Name(s)] · Ownership %: [%]
[If required: personal guarantee acknowledgment]

## Business References
1. [Bank/vendor reference]

## Certification
The undersigned certifies the above information is accurate and authorizes the processor to verify it, including a credit check if applicable.

Signature: ______________________  Date: ____________

*Never write full bank account or card numbers on a plain form like this — provide account details through the processor's own secure onboarding portal, which is how legitimate processors actually collect this information.*`,
  },
  {
    slug: "charitable-remainder-trust-template",
    name: "Charitable Remainder Trust Outline",
    seoTitle: "Free Charitable Remainder Trust Outline Template",
    description: "Free charitable remainder trust outline — an income-generating trust that eventually passes its remaining assets to charity.",
    category: "Legal",
    bodyMarkdown: `# Charitable Remainder Trust (Outline)

**Grantor:** [Name]
**Trustee:** [Name/Institution]
**Charitable Beneficiary:** [Charity Name]
**Date:** [Date]

## 1. Purpose
Grantor transfers assets to this trust, which will pay income to [Grantor / a named non-charitable beneficiary] for [a term of years / the beneficiary's lifetime], with the remaining trust assets passing to the named charity thereafter.

## 2. Trust Type
[ ] Charitable Remainder Annuity Trust (CRAT) — fixed dollar payment
[ ] Charitable Remainder Unitrust (CRUT) — fixed percentage of trust value, revalued annually

## 3. Payout Rate
[%] of [initial trust value (CRAT) / annually revalued trust value (CRUT)], paid [Frequency], meeting the IRS-required minimum payout rate.

## 4. Trustee's Powers
Trustee will invest and manage trust assets prudently, consistent with generating the required income payout.

## 5. Term
This trust continues for [Number of years, not exceeding 20 / the lifetime of the named beneficiary(ies)].

## 6. Remainder to Charity
Upon termination, all remaining trust assets pass to [Charity Name], which must be a qualified 501(c)(3) organization.

---
Grantor: ______________________  Date: ____________
Trustee (acceptance): ______________________  Date: ____________

*This document is provided for informational and educational purposes only and is NOT a substitute for legal or tax advice. Charitable remainder trusts have strict IRS qualification requirements (minimum/maximum payout rates, a required minimum charitable remainder value) — an improperly drafted CRT can lose its tax benefits entirely. Use a licensed estate planning attorney and CPA to establish one.*`,
  },
  {
    slug: "compliance-certificate-template",
    name: "Compliance Certificate",
    seoTitle: "Free Compliance Certificate Template",
    description: "Free compliance certificate template — a borrower confirms to a lender that loan covenants are currently being met.",
    category: "Finance",
    bodyMarkdown: `# Compliance Certificate
...
The undersigned, an authorized officer of Borrower, certifies as follows:

## 1. Financial Covenants
| Covenant | Required | Actual | Compliant? |
|----------|----------|--------|------------------|
| [e.g. Debt-to-EBITDA ratio] | [Requirement] | [Actual] | [Yes/No] |
| [e.g. Minimum current ratio] | [Requirement] | [Actual] | [Yes/No] |

## 2. No Default
Borrower is not aware of any event of default, or event that with notice or the passage of time would become an event of default, under the Loan Agreement.

## 3. Financial Statements
The attached financial statements are true and correct and prepared in accordance with [GAAP/applicable standard].

---
Certified by: ______________________  Date: ____________
[Name, Title, Borrower]

*Most loan agreements require this certificate on a set schedule (quarterly is common) — mark your calendar, since missing the deadline to certify can itself sometimes trigger a technical default under the loan terms.*`,
  },
  {
    slug: "secretarys-certificate-template",
    name: "Secretary's Certificate",
    seoTitle: "Free Secretary's Certificate Template",
    description: "Free secretary's certificate template — a corporate secretary certifies board resolutions, bylaws, or officer authority for a third party.",
    category: "Legal",
    bodyMarkdown: `# Secretary's Certificate

**Company:** [Company Name]

I, [Name], Secretary of [Company Name], hereby certify as follows:

## 1. Incumbency
The following individuals are duly elected and currently serving officers/directors of the Company, holding the titles indicated:
...
## 2. Board Resolution
Attached hereto is a true and correct copy of resolutions duly adopted by the Board of Directors on [Date], which resolutions remain in full force and effect and have not been amended or rescinded.

## 3. Bylaws
Attached hereto is a true and correct copy of the Company's Bylaws as currently in effect.

## 4. Authority
[Name], as [Title], is authorized to execute [the specific agreement/transaction] on behalf of the Company.

---
Secretary signature: ______________________  Date: ____________
[Name], Secretary

*Banks, title companies, and counterparties in larger transactions commonly require this exact document to confirm someone actually has authority to sign on the company's behalf — keeping current officer/bylaw information ready speeds up any transaction that needs one.*`,
  },
  {
    slug: "bank-confirmation-letter-template",
    name: "Bank Confirmation Letter",
    seoTitle: "Free Bank Confirmation Letter Template",
    description: "Free bank confirmation letter template — a bank confirms account balances or credit facilities for an auditor or third party.",
    category: "Finance",
    bodyMarkdown: `# Bank Confirmation Letter

[Bank Name/Letterhead]
[Date]

**To:** [Auditor/Requesting Party Name]
**Re: Confirmation of Account Information for [Company Name]**

At the request of [Company Name], we confirm the following information as of [Date]:

## Account Information

| Account Type | Account Number (last 4 digits) | Balance |
|-------------------|-------------------------------------|---------|
| [Checking] | [XXXX] | [Amount] |
| [Savings] | [XXXX] | [Amount] |

## Credit Facilities (if applicable)
| Facility Type | Limit | Outstanding Balance |
|--------------------|-------|---------------------------|
| [Line of credit] | [Amount] | [Amount] |

## Other Relationships
[Any other relevant financial relationships — letters of credit, collateral held, etc.]

This confirmation is provided solely for audit purposes as of the date stated above and does not constitute a guarantee of future account status.

---
[Bank Officer Name, Title]
[Bank Name]

*This document is provided for informational and educational purposes only — a real bank confirmation must come directly from the bank (often sent directly to the auditor, not through the company) to have any audit value; a company can't self-issue this on the bank's behalf.*`,
  },
  {
    slug: "audit-engagement-letter-template",
    name: "Audit Engagement Letter",
    seoTitle: "Free Audit Engagement Letter Template",
    description: "Free audit engagement letter template — an auditor's formal agreement with a client defining the scope and terms of an audit.",
    category: "Finance",
    bodyMarkdown: `# Audit Engagement Letter

[Audit Firm Name/Letterhead]
[Date]
...
This letter confirms our understanding of the terms of our engagement to audit [Company Name]'s financial statements for the period ending [Date].

## Objective and Scope
We will conduct our audit in accordance with [GAAS/applicable auditing standards], with the objective of expressing an opinion on whether the financial statements are presented fairly in accordance with [GAAP/applicable framework].

## Management's Responsibilities
Management is responsible for the preparation of the financial statements, maintaining internal controls, and providing us with access to all relevant records and personnel.

## Our Responsibilities
An audit provides reasonable, not absolute, assurance that the financial statements are free of material misstatement. It is not designed to detect all instances of fraud or error.

## Fees
Our fees for this engagement are estimated at [Amount], billed [Terms].

## Reporting
We expect to issue our report by [Date], assuming timely access to needed information.
...
---
Accepted:
[Client Representative]: ______________________  Date: ____________

*The "reasonable, not absolute, assurance" language isn't boilerplate — it's a legally significant clarification of what an audit opinion does and doesn't guarantee, and it protects both the auditor and the client from a misunderstanding about audit scope.*`,
  },
  {
    slug: "child-care-authorization-template",
    name: "Child Care Authorization",
    seoTitle: "Free Child Care Authorization Form Template",
    description: "Free child care authorization form — a parent authorizes a specific caregiver to make decisions or pick up their child.",
    category: "Legal",
    bodyMarkdown: `# Child Care Authorization

I, [Parent/Guardian Name], parent/legal guardian of [Child's Name], authorize [Caregiver Name] to:

## Authorized Actions
[ ] Pick up my child from [School/Daycare Name]
[ ] Provide care for my child at [Location]
[ ] Authorize emergency medical treatment if I cannot be reached
[ ] Make routine decisions regarding my child's care

## Period of Authorization
This authorization is valid from [Start Date] to [End Date].

## Emergency Contact
Me: [Phone] · Alternate: [Name, Phone]

## Medical Information
Allergies: [List, or "None"] · Medications: [List, or "None"]

## Caregiver Information
Name: [Name] · Relationship to family: [Relationship] · Phone: [Phone]

---
Parent/Guardian signature: ______________________  Date: ____________

*If this authorization includes emergency medical treatment consent, keep a copy with the caregiver at all times — a school or hospital will typically want to see it before acting on a non-parent's authorization.*`,
  },
  {
    slug: "consent-to-assignment-template",
    name: "Consent to Assignment",
    seoTitle: "Free Consent to Assignment Template",
    description: "Free consent to assignment template — a third party (like a landlord or lender) formally approves a contract being assigned to a new party.",
    category: "Legal",
    bodyMarkdown: `# Consent to Assignment

**Original Party (Assignor):** [Name]
**New Party (Assignee):** [Name]
**Consenting Party:** [Name — e.g. Landlord, Lender]
**Original Agreement:** [Reference — name and date]
**Date:** [Date]

The undersigned, being a party to or having rights under the Original Agreement referenced above, hereby consents to the assignment of Assignor's rights and obligations under that Agreement to Assignee.

## Conditions of Consent (if any)
[State any conditions attached to this consent — e.g. "Assignee assumes all obligations of Assignor" or "Assignor remains secondarily liable."]

## No Other Waiver
This consent applies only to the specific assignment described above and does not waive any other right the Consenting Party may have under the Original Agreement.

---
Consenting Party: ______________________  Date: ____________
[Name, Title]

*Many contracts (especially commercial leases and loan agreements) explicitly require this kind of written consent before an assignment is valid — proceeding without it can void the assignment entirely, even if the original two parties agreed between themselves.*`,
  },
  {
    slug: "publishing-agreement-template",
    name: "Publishing Agreement",
    seoTitle: "Free Publishing Agreement Template",
    description: "Free publishing agreement template between an author and a publisher for a book or written work.",
    category: "Business",
    bodyMarkdown: `# Publishing Agreement
...
## 1. Grant of Rights
Author grants Publisher the [exclusive/non-exclusive] right to publish, print, distribute, and sell the Work in [Territory] and [Formats — print, ebook, audiobook], for [Duration/term].

## 2. Delivery
Author will deliver the final manuscript by [Date], meeting [word count/format requirements].

## 3. Advance and Royalties
Advance: [Amount], recoupable against royalties.
Royalty rate: [%] of [net receipts / cover price], paid [Frequency].

## 4. Editorial Process
[Describe editorial review/approval process, and Author's rights over final content changes.]

## 5. Rights Reserved to Author
[e.g. Author retains film/foreign translation rights, unless separately negotiated.]

## 6. Out of Print / Reversion
If the Work goes out of print or sales fall below [Threshold] for [Duration], rights revert to Author upon request.

## 7. Warranty
Author warrants the Work is original and does not infringe any third party's rights.

---
Author: ______________________  Date: ____________
Publisher: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Rights reversion terms (Section 6) matter enormously to an author's long-term interests — a book that goes out of print with no reversion clause can leave an author unable to republish or sell rights elsewhere.*`,
  },
  {
    slug: "notice-of-breach-of-contract-template",
    name: "Notice of Breach of Contract",
    seoTitle: "Free Notice of Breach of Contract Template",
    description: "Free notice of breach of contract template — formally notifies the other party they've failed to meet their contractual obligations.",
    category: "Legal",
    bodyMarkdown: `# Notice of Breach of Contract
...
**RE: Notice of Breach — [Contract Reference/Date]**

Dear [Recipient Name],

This letter serves as formal notice that you are in breach of [Contract Name], dated [Date], specifically:

## Nature of the Breach
[Specific provision breached, and factual description of how — cite the exact section number if possible.]

## Demand for Cure
Per Section [X] of the Agreement [or, if the contract has no cure provision: "we demand"], you must cure this breach by [specific action] within [Number] days of this notice, i.e. by [Date].

## Consequences of Failure to Cure
If this breach is not cured by the date above, we will consider the contract terminated / pursue damages / [other remedy available under the contract], without further notice.

We remain willing to resolve this matter directly if you cure the breach as described.

Sincerely,
[Your Name]

*Check the contract's own notice-and-cure provisions before sending this — many contracts specify a required cure period and delivery method, and skipping that step can undermine your ability to later terminate or sue for breach.*`,
  },
  {
    slug: "promissory-note-assignment-template",
    name: "Promissory Note Assignment",
    seoTitle: "Free Promissory Note Assignment Template",
    description: "Free promissory note assignment template — transfers a lender's right to receive payment under an existing note to a new party.",
    category: "Finance",
    bodyMarkdown: `# Assignment of Promissory Note

**Assignor (current holder):** [Name]
**Assignee (new holder):** [Name]
**Original Note:** dated [Date], made by [Borrower Name], in the original principal amount of [Amount]
**Date of Assignment:** [Date]

## 1. Assignment
For value received, Assignor hereby transfers and assigns to Assignee all right, title, and interest in and to the promissory note described above, including all rights to receive principal and interest payments.

## 2. Outstanding Balance
As of the date of this assignment, the outstanding balance of the Note is [Amount].

## 3. Notice to Borrower
Assignor and/or Assignee will notify Borrower of this assignment and direct future payments to Assignee.

## 4. Warranty
Assignor warrants that the Note is valid, that Assignor is its lawful holder, and that the stated outstanding balance is accurate.

## 5. No Recourse (or specify otherwise)
[State whether Assignor has any ongoing liability if Borrower defaults after assignment, or whether the assignment is "without recourse."]

---
Assignor: ______________________  Date: ____________
Assignee: ______________________  Date: ____________

*Notifying the borrower promptly and clearly (Section 3) is essential — a borrower who keeps paying the original holder in good faith, without proper notice of the assignment, is generally protected until they actually receive notice of the change.*`,
  },
  {
    slug: "vacation-policy-template",
    name: "Vacation Policy",
    seoTitle: "Free Vacation (PTO) Policy Template",
    description: "Free vacation/PTO policy template outlining how paid time off accrues, is requested, and is paid out.",
    category: "HR",
    bodyMarkdown: `# Vacation Policy

**Company:** [Company Name] · **Effective Date:** [Date]

## Accrual
Employees accrue [Number] days of paid vacation per year, [accruing monthly/per pay period], starting from their hire date.

## Eligibility
[Any waiting period before new employees can use accrued time — e.g. "after 90 days of employment."]

## Requesting Time Off
Requests should be submitted at least [Number] days in advance via [System/process], subject to manager approval based on business needs.

## Carryover
[ ] Unused vacation carries over up to [Number] days into the next year.
[ ] Unused vacation does not carry over ("use it or lose it," where legally permitted).

## Payout Upon Termination
[State whether unused accrued vacation is paid out upon termination — required by law in some states regardless of company policy.]

## Blackout Periods (if applicable)
[Any periods where vacation requests are limited due to business needs.]

---
Acknowledged by: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. A number of US states legally require accrued, unused vacation to be paid out at termination and prohibit "use it or lose it" policies entirely — confirm your state's specific rules before finalizing this policy.*`,
  },
  {
    slug: "workers-compensation-policy-template",
    name: "Workers' Compensation Policy",
    seoTitle: "Free Workers' Compensation Policy Template",
    description: "Free workers' compensation policy template explaining an employer's coverage and the process for reporting a workplace injury.",
    category: "HR",
    bodyMarkdown: `# Workers' Compensation Policy

**Company:** [Company Name] · **Effective Date:** [Date]

## Coverage
[Company Name] carries workers' compensation insurance through [Insurance Carrier], covering employees for injuries or illnesses arising out of and in the course of employment, as required by [State] law.

## Reporting an Injury
Any workplace injury, no matter how minor, must be reported to [Manager/HR] immediately, and no later than [Timeframe required by state law].

## What Happens Next
1. Seek medical attention if needed (emergency care first, always).
2. Complete an incident report with [HR/Manager].
3. HR files the workers' compensation claim with our insurance carrier.
4. The insurance carrier will communicate with the employee about benefits and next steps.

## Return to Work
[Describe any light-duty/modified work program available during recovery, if applicable.]

## Retaliation Prohibited
[Company Name] does not tolerate retaliation against any employee for reporting a workplace injury or filing a workers' compensation claim.

---
Acknowledged by: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Workers' compensation is a state-regulated, no-fault system with specific reporting deadlines and required processes — confirm your state's exact requirements, since missing a reporting deadline can affect an employee's eligibility for benefits.*`,
  },
  {
    slug: "fraternization-policy-template",
    name: "Fraternization Policy",
    seoTitle: "Free Workplace Fraternization Policy Template",
    description: "Free fraternization (workplace dating) policy template addressing romantic relationships between coworkers, especially across reporting lines.",
    category: "HR",
    bodyMarkdown: `# Fraternization Policy

**Company:** [Company Name] · **Effective Date:** [Date]

## Purpose
This policy addresses romantic or dating relationships between employees, with a focus on preventing conflicts of interest and favoritism, particularly across reporting relationships.

## Relationships Between Peers
Consensual relationships between employees at the same level, in different departments with no reporting relationship, are generally permitted, though discretion at work is expected.

## Relationships Involving a Reporting Relationship
Romantic relationships between a manager and a direct report (or anyone in their reporting chain) are prohibited, due to the inherent conflict of interest and power imbalance. If such a relationship exists or develops, it must be disclosed to HR immediately so reporting lines can be adjusted.

## Disclosure
Employees involved in a relationship covered by this policy must disclose it to [HR contact], who will determine next steps confidentially.

## Consequences
Failure to disclose a relationship covered by this policy, or continuing to supervise someone you're in a relationship with after being asked to disclose, may result in disciplinary action.

---
Acknowledged by: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. The goal of the disclosure requirement is preventing conflicts of interest, not policing employees' personal lives — apply it consistently regardless of the genders or seniority of those involved to avoid discrimination claims.*`,
  },
  {
    slug: "no-bid-letter-template",
    name: "No Bid Letter",
    seoTitle: "Free No Bid Letter Template",
    description: "Free no-bid letter template for formally declining to submit a proposal in response to an RFP or tender.",
    category: "Business",
    bodyMarkdown: `# No Bid Letter

[Date]

[Issuing Organization Name]

**RE: No Bid — [RFP/Tender Reference #]**

Dear [Contact Name],

Thank you for the opportunity to bid on [RFP/Tender Name], reference #[Number]. After careful consideration, [Company Name] has decided not to submit a proposal for this opportunity at this time.

## Reason (optional)
[Brief, professional reason if you choose to share one — e.g. "the timeline does not align with our current capacity" or "this falls outside our current service scope."]

We appreciate being included in this process and would welcome the opportunity to bid on future opportunities that better align with our capabilities.

Sincerely,
[Your Name/Company]

*Sending a brief, professional no-bid letter (rather than simply not responding) keeps you in good standing for future opportunities with the same buyer — silence can read as disorganization rather than a deliberate decision.*`,
  },
  {
    slug: "change-order-form-template",
    name: "Change Order Form",
    seoTitle: "Free Change Order Form Template",
    description: "Free change order form template for documenting and approving a scope, cost, or timeline change on a construction or project contract.",
    category: "Business",
    bodyMarkdown: `# Change Order
...
## Description of Change
[What's changing from the original scope — be specific.]

## Reason for Change
[Why this change is needed — e.g. unforeseen site condition, client-requested addition.]

## Cost Impact
Original contract amount: [Amount]
Cost of this change: [Amount, itemized if helpful]
**Revised contract amount: [Amount]**

## Schedule Impact
Original completion date: [Date]
Additional time requested: [Number] days
**Revised completion date: [Date]**

## Approval
This change order must be signed by both parties before work on this change begins.

Contractor: ______________________  Date: ____________
Owner/Client: ______________________  Date: ____________

*Getting the change order signed BEFORE starting the additional work — not after — is what actually protects a contractor from doing extra work they never get paid for, and protects a client from surprise charges.*`,
  },
  {
    slug: "capital-expenditure-request-form-template",
    name: "Capital Expenditure Request Form",
    seoTitle: "Free Capital Expenditure (CapEx) Request Form Template",
    description: "Free capital expenditure request form template for proposing and approving a major equipment or asset purchase.",
    category: "Finance",
    bodyMarkdown: `# Capital Expenditure Request

**Requested by:** [Name/Department] · **Date:** [Date]

## Item/Project
[Description of the capital asset or project being proposed]

## Cost
Total estimated cost: [Amount]
Funding source: [Budget line/capital budget category]

## Justification
[Why this expenditure is needed — cost savings, capacity, replacement of failing equipment, etc.]

## Expected Return / Payback
[Estimated payback period or ROI, if applicable — e.g. "pays for itself in labor savings within 18 months."]

## Alternatives Considered
[Other options evaluated, and why this one was chosen — e.g. lease vs. buy, different vendors.]

## Depreciation Impact (if known)
[Estimated useful life and depreciation method, if relevant to the approval.]

## Approval

| Role | Name | Decision | Date |
|------|------|----------|------|
| Department Head | [Name] | [ ] Approved [ ] Rejected | [Date] |
| Finance/CFO | [Name] | [ ] Approved [ ] Rejected | [Date] |

*Including an expected payback or ROI estimate (even a rough one) is what separates a real capital request from a wish-list item — it gives approvers something concrete to evaluate against other competing requests.*`,
  },
  {
    slug: "security-services-contract-template",
    name: "Security Services Contract",
    seoTitle: "Free Security Services Contract Template",
    description: "Free security services contract template for hiring a security guard company or service for a property or event.",
    category: "Business",
    bodyMarkdown: `# Security Services Contract

**Client:** [Name]
**Security Provider:** [Company Name, license # if required in your state]
**Effective Date:** [Date]

## 1. Services
Provider will supply [Number] security personnel to [Location] for [Coverage hours/days], performing: [Duties — patrol, access control, monitoring, etc.].

## 2. Personnel Requirements
Provider's personnel will be [licensed/bonded as required by state law], and Provider will conduct background checks on all assigned staff.

## 3. Fee
[Hourly rate per guard] × [hours], invoiced [Frequency].

## 4. Equipment
[State who provides uniforms, radios, vehicles, or other equipment.]

## 5. Liability and Insurance
Provider will maintain general liability insurance of at least [Amount] and will indemnify Client for claims arising from Provider's negligence.

## 6. Emergency Procedures
[Describe expected response to specific emergency scenarios, and communication protocol with Client and, where appropriate, law enforcement.]
...
---
Client: ______________________  Date: ____________
Security Provider: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Security guard companies and individual guards are licensed in most states — confirm both the company and assigned personnel hold current, valid licenses before engaging them.*`,
  },
  {
    slug: "pay-increase-letter-template",
    name: "Pay Increase Letter",
    seoTitle: "Free Pay Increase Letter Template",
    description: "Free pay increase letter template — an employer formally notifies an employee of a salary increase.",
    category: "HR",
    bodyMarkdown: `# Pay Increase Letter

[Date]

Dear [Employee Name],

I'm pleased to let you know that your salary is being increased, effective [Date].

## Details
Current salary: [Amount] · New salary: [Amount] ([%] increase)
Reason: [e.g. "in recognition of your performance over the past year" / "as part of our annual compensation review"]

## What This Means
This change will be reflected in your paycheck starting [Date/pay period]. [Note any related changes — e.g. updated benefits contributions, if applicable.]
...
*Pairing the pay increase with a specific, genuine reason (not just a number) reinforces what behavior or results you want to see more of — it turns a raise into recognition, not just a line-item change.*`,
  },
  {
    slug: "job-offer-acceptance-letter-template",
    name: "Job Offer Acceptance Letter",
    seoTitle: "Free Job Offer Acceptance Letter Template",
    description: "Free job offer acceptance letter template — a candidate formally accepts a job offer in writing.",
    category: "HR",
    bodyMarkdown: `# Job Offer Acceptance Letter

[Date]

Dear [Hiring Manager Name],

I am writing to formally accept your offer for the position of [Job Title] at [Company Name], as outlined in your offer letter dated [Date].

## Confirming the Details
Start date: [Date] · Salary: [Amount] · Reporting to: [Manager Name]
[Any other key terms worth confirming in writing — benefits start date, signing bonus, relocation.]

I'm looking forward to joining the team and contributing to [Company Name]'s success. Please let me know if there's anything you need from me before my start date.

Sincerely,
[Your Name]

*Restating the key terms in your own acceptance (not just saying "I accept") creates a clear written record both sides can point back to if there's ever a misunderstanding about start date or compensation.*`,
  },
  {
    slug: "travel-expense-report-template",
    name: "Travel Expense Report",
    seoTitle: "Free Travel Expense Report Template",
    description: "Free travel expense report template for employees to itemize and submit business travel costs for reimbursement.",
    category: "Finance",
    bodyMarkdown: `# Travel Expense Report

**Employee:** [Name] · **Trip Purpose:** [Purpose]
**Travel Dates:** [Start] – [End] · **Destination:** [City]

| Date | Category (Airfare/Hotel/Meals/Transport/Other) | Description | Amount |
|------|-------------------------------------------------------|--------------|--------|
| [Date] | [Category] | [Description] | [Amount] |
| [Date] | [Category] | [Description] | [Amount] |

**Total Expenses:** [Amount]
**Cash Advance Received (if any):** [Amount]
**Amount Owed to Employee / Owed to Company:** [Amount]

## Receipts
[ ] Itemized receipts attached for all expenses over [Company threshold, e.g. $25]

---
Employee signature: ______________________  Date: ____________
Approved by: ______________________  Date: ____________

*Submitting this within days of returning (not weeks later) while receipts and memory are still fresh is what actually keeps expense reports accurate and reimbursement fast.*`,
  },
  {
    slug: "child-protection-policy-template",
    name: "Child Protection Policy",
    seoTitle: "Free Child Protection Policy Template",
    description: "Free child protection policy template for organizations that work with children — camps, schools, youth sports, nonprofits.",
    category: "Legal",
    bodyMarkdown: `# Child Protection Policy

**Organization:** [Name] · **Effective Date:** [Date]

## Purpose
[Organization Name] is committed to providing a safe environment for all children in our programs and to preventing abuse, neglect, and exploitation.

## Screening
All staff and volunteers who work directly with children undergo a background check before starting, renewed [Frequency].

## Code of Conduct
Staff and volunteers must:
- Never be alone with a single child in an unobservable location
- Use appropriate, non-physical discipline only
- Report any concerning behavior by another staff member or volunteer immediately

## Reporting Suspected Abuse
Any staff member or volunteer who suspects abuse or neglect must report it immediately to [Designated Officer/Title], who will [follow mandatory reporting requirements under applicable law].

## Training
All staff and volunteers complete child protection training before working with children and annually thereafter.

## Parent/Guardian Communication
[How parents are informed of policies, and how to raise a concern.]

---
Adopted by: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Most jurisdictions impose mandatory reporting obligations on anyone working with children — know your specific legal reporting duties and timeline, since failing to report can itself carry legal consequences.*`,
  },
  {
    slug: "customer-list-purchase-agreement-template",
    name: "Customer List Purchase Agreement",
    seoTitle: "Free Customer List Purchase Agreement Template",
    description: "Free customer list purchase agreement template for buying or selling a business's customer/client list as a standalone asset.",
    category: "Business",
    bodyMarkdown: `# Customer List Purchase Agreement

**Seller:** [Name] · **Buyer:** [Name] · **Date:** [Date]

## 1. Sale of Customer List
Seller agrees to sell, and Buyer agrees to purchase, the customer list described as: [Description — number of contacts, industry, source].

## 2. Purchase Price
Buyer will pay Seller [Amount], payable [Terms].

## 3. Warranties
Seller warrants that:
1. Seller owns the list and has the right to sell it.
2. The list was collected in compliance with applicable privacy and anti-spam laws (e.g. CAN-SPAM, GDPR where applicable).
3. [State whether contacts have consented to being contacted by a new party, if relevant.]

## 4. Exclusivity
[State whether Seller retains a copy/can continue using the list, or whether this is an exclusive transfer.]

## 5. Non-Solicitation (optional)
[If applicable: Seller agrees not to independently solicit these same customers for [Period].]

---
Seller: ______________________  Date: ____________
Buyer: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Buying a customer list carries real privacy-law risk — contacts who never consented to being contacted by a new, unrelated company can trigger CAN-SPAM, GDPR, or similar violations regardless of what this agreement says between buyer and seller.*`,
  },
  {
    slug: "branding-proposal-template",
    name: "Branding Proposal",
    seoTitle: "Free Branding Proposal Template",
    description: "Free branding proposal template for pitching a brand identity project — strategy, deliverables, and pricing.",
    category: "Business",
    bodyMarkdown: `# Branding Proposal

**Prepared for:** [Client Name] · **Prepared by:** [Your Name/Agency]
**Date:** [Date]

## Project Overview
[Brief summary of the client's brand challenge/opportunity and what this project will deliver.]

## Scope of Work
- [ ] Brand strategy & positioning
- [ ] Logo design ([Number] concepts, [Number] revisions)
- [ ] Color palette & typography system
- [ ] Brand guidelines document
- [ ] [Additional deliverables — business cards, social templates, etc.]

## Process & Timeline
| Phase | Description | Duration |
|-------|-------------|----------|
| Discovery | [Description] | [Duration] |
| Concept Development | [Description] | [Duration] |
| Refinement | [Description] | [Duration] |
| Delivery | [Description] | [Duration] |

## Investment
Total project fee: [Amount], payable [Terms — e.g. 50% upfront, 50% on delivery].

## Why [Your Agency/Name]
[Brief, specific reason — relevant past work, unique approach — not generic self-praise.]

*A proposal that shows the actual process (not just the final deliverables) helps a client understand what they're paying for at each stage, and sets realistic expectations for how many rounds of revisions are included.*`,
  },
  {
    slug: "model-release-form-template",
    name: "Model Release Form",
    seoTitle: "Free Model Release Form Template",
    description: "Free model release form template — a person photographed or filmed grants permission for the content to be used commercially.",
    category: "Legal",
    bodyMarkdown: `# Model Release Form

I, [Model Name], grant [Photographer/Company Name] the irrevocable right to use my likeness, in photographs/video taken on [Date] at [Location], for the following purposes:
...
## Compensation
[ ] No compensation — model releases these rights voluntarily.
[ ] Model receives [Amount/consideration described] in exchange for this release.

## Duration
This release is [perpetual / valid for [Period]] and covers [worldwide / specific territory] use.

## Model's Rights
Model waives any right to inspect or approve the finished product using their likeness, unless otherwise agreed in writing.

## If Model Is a Minor
Parent/guardian signature required below.

---
Model signature: ______________________  Date: ____________
Parent/guardian (if minor): ______________________  Date: ____________
Photographer/Company: ______________________  Date: ____________

*Getting this signed BEFORE the shoot (not after, when someone may have second thoughts about how they look) is standard practice — most professional photographers won't shoot commercial content without one in hand.*`,
  },
  {
    slug: "contract-renewal-notice-template",
    name: "Contract Renewal Notice",
    seoTitle: "Free Contract Renewal Notice Template",
    description: "Free contract renewal notice template for notifying the other party that a contract is renewing or that renewal terms are changing.",
    category: "Business",
    bodyMarkdown: `# Contract Renewal Notice

[Date]

[Recipient Name]

**RE: Renewal Notice — [Contract Name/Reference], expiring [Date]**

Dear [Recipient Name],

This letter serves as notice that the above-referenced contract is set to [automatically renew / expire] on [Date], per Section [X] of the agreement.

## Renewal Terms
[ ] The contract will renew automatically under its current terms unless either party provides notice of non-renewal by [Date].
[ ] We propose renewing under the following updated terms: [Describe any changes — price, scope, duration].

## Action Needed
[If a signature or response is required to renew: "Please confirm your intent to renew by signing and returning this notice by [Date]."]

We value our relationship and look forward to continuing to work together.

Sincerely,
[Your Name/Company]

*Sending this well before the contract's notice deadline (not on the deadline itself) avoids an unwanted auto-renewal or an unintended lapse — check the original contract's exact notice period before sending.*`,
  },
  {
    slug: "advertising-insertion-order-template",
    name: "Advertising Insertion Order",
    seoTitle: "Free Advertising Insertion Order Template",
    description: "Free advertising insertion order template — confirms the specific ad placement, dates, and cost agreed between advertiser and publisher.",
    category: "Business",
    bodyMarkdown: `# Advertising Insertion Order

**IO #:** [Number] · **Date:** [Date]
**Advertiser:** [Company Name] · **Publisher/Media:** [Name]

## Placement Details
| Placement | Ad Size/Format | Start Date | End Date | Rate | Total Cost |
|-----------|---------------------|-----------------|---------------|------|-----------------|
| [Placement] | [Format] | [Date] | [Date] | [Rate] | [Amount] |

## Creative Specifications
[File format, dimensions, deadline for creative delivery.]

## Payment Terms
[Terms — e.g. Net 30, due upon insertion.]

## Cancellation
[Notice required to cancel before the placement runs, and any cancellation fee.]

## Makegoods
[Policy for compensating the advertiser if the ad fails to run as ordered — e.g. an equivalent placement at no charge.]

---
Advertiser: ______________________  Date: ____________
Publisher: ______________________  Date: ____________

*Confirming exact placement dates and cancellation terms in writing (not just a verbal agreement with a sales rep) is what protects an advertiser if a campaign needs to change or a placement gets bumped.*`,
  },
  {
    slug: "new-customer-welcome-letter-template",
    name: "New Customer Welcome Letter",
    seoTitle: "Free New Customer Welcome Letter Template",
    description: "Free new customer welcome letter template for greeting a new customer and setting expectations after their first purchase or signup.",
    category: "Business",
    bodyMarkdown: `# Welcome Letter

Dear [Customer Name],

Welcome to [Company Name]! We're thrilled to have you as a customer and wanted to personally reach out.

## Getting Started
[Key next steps — how to access your account, where to find support, what to expect next.]

## Your Point of Contact
If you ever have questions, reach out to [Name/Team] at [Email/Phone] — we're here to help.

## What's Next
[Brief overview of onboarding steps, upcoming communications, or resources — help center link, onboarding call, etc.]
...
*A welcome message that tells the customer exactly what to do next (not just "welcome aboard!") measurably reduces early drop-off — give them one clear first action, not five.*`,
  },
  {
    slug: "funding-request-letter-template",
    name: "Funding Request Letter",
    seoTitle: "Free Funding Request Letter Template",
    description: "Free funding request letter template for a nonprofit or organization asking a funder or donor for financial support.",
    category: "Business",
    bodyMarkdown: `# Funding Request Letter

[Date]

Dear [Funder Name],

On behalf of [Organization Name], I'm writing to request funding of [Amount] to support [Project/Program Name].

## The Need
[Concrete, specific description of the problem this funding addresses — with data where possible.]

## Our Approach
[What the organization will do with the funding, and why this approach works.]

## Impact
[Expected, measurable outcomes — e.g. "will serve 200 families" or "will fund X hours of direct service."]
...
We would welcome the opportunity to discuss this request further. Thank you for considering our proposal.

Sincerely,
[Name, Title]
[Organization Name]

*Leading with the specific, measurable impact the funding will produce (not just the organization's general mission) is what actually moves a funder from "interesting" to "yes" — vague asks get vague answers.*`,
  },
  {
    slug: "sponsorship-request-letter-template",
    name: "Sponsorship Request Letter",
    seoTitle: "Free Sponsorship Request Letter Template",
    description: "Free sponsorship request letter template for asking a business to sponsor an event, team, or initiative.",
    category: "Business",
    bodyMarkdown: `# Sponsorship Request Letter

[Date]

Dear [Sponsor Contact Name],

I'm writing on behalf of [Organization/Event Name] to invite [Company Name] to become a sponsor of [Event/Initiative], taking place on [Date].

## About [Event/Initiative]
[Brief description — who it reaches, why it matters.]

## Sponsorship Opportunities
| Tier | Investment | Benefits |
|------|-----------------|----------|
| [Tier 1] | [Amount] | [Logo placement, mentions, booth space, etc.] |
| [Tier 2] | [Amount] | [Benefits] |

## Why Partner With Us
[Specific alignment between the sponsor's audience/values and your event — not a generic pitch.]

We'd love to discuss how a partnership could work for [Company Name]. Please let me know if you'd like to set up a call.

Sincerely,
[Your Name, Organization]

*Naming a specific benefit that matters to THIS sponsor (audience overlap, brand alignment, local visibility) rather than a generic tier sheet is what actually gets a response from a busy marketing contact.*`,
  },
  {
    slug: "affidavit-of-death-of-joint-tenant-template",
    name: "Affidavit of Death of Joint Tenant",
    seoTitle: "Free Affidavit of Death of Joint Tenant Template",
    description: "Free affidavit of death of joint tenant template — used to clear title to real estate held in joint tenancy after one owner dies.",
    category: "Real Estate",
    bodyMarkdown: `# Affidavit of Death of Joint Tenant
...
I, [Surviving Joint Tenant Name], being duly sworn, depose and state:

## 1. Property
The property located at [Property Address], legally described as [Legal Description], was held in joint tenancy with right of survivorship by myself and [Deceased Joint Tenant Name].

## 2. Death of Joint Tenant
[Deceased Joint Tenant Name] died on [Date of Death], as shown by the attached certified copy of the death certificate.

## 3. Survivorship
Upon the death of [Deceased Joint Tenant Name], title to the property vested solely in me, [Surviving Joint Tenant Name], by operation of the right of survivorship.

## 4. Purpose
This affidavit is recorded to provide public notice of the change in title resulting from the death described above.
...
*This document is provided for informational and educational purposes only and does not constitute legal advice. This affidavit must be recorded with the county recorder/land records office where the property is located, along with a certified copy of the death certificate, to actually update the public title record.*`,
  },
  {
    slug: "employee-performance-review-template",
    name: "Employee Performance Review",
    seoTitle: "Free Employee Performance Review Template",
    description: "Free employee performance review template for a manager to evaluate an employee's performance over a review period.",
    category: "HR",
    bodyMarkdown: `# Employee Performance Review

**Employee:** [Name] · **Position:** [Title]
**Review Period:** [Start Date] – [End Date] · **Reviewer:** [Manager Name]

## Overall Rating
[ ] Exceeds Expectations  [ ] Meets Expectations  [ ] Needs Improvement  [ ] Unsatisfactory

## Key Accomplishments
[Specific results and contributions during this period.]

## Areas for Development
[Specific, constructive feedback — tied to observable behavior, not personality.]
...
## Employee Comments
[Space for employee's self-assessment or response]

---
Employee signature: ______________________  Date: ____________
*(Signature acknowledges the review was discussed, not necessarily agreement with every point.)*
Manager signature: ______________________  Date: ____________

*Reviews built entirely around specific, observable examples (not general impressions like "great attitude") are both more useful to the employee and more defensible if a rating is ever challenged.*`,
  },
  {
    slug: "company-vehicle-use-policy-template",
    name: "Company Vehicle Use Policy",
    seoTitle: "Free Company Vehicle Use Policy Template",
    description: "Free company vehicle use policy template covering who can drive company vehicles, permitted use, and accident procedures.",
    category: "HR",
    bodyMarkdown: `# Company Vehicle Use Policy

**Company:** [Company Name] · **Effective Date:** [Date]

## Eligibility
Only employees with a valid driver's license and a clean driving record (verified via [MVR check frequency]) may operate company vehicles.

## Permitted Use
[ ] Business use only.
[ ] Limited personal use permitted, subject to: [Conditions].

## Driver Responsibilities
- Follow all traffic laws
- No use of a handheld phone while driving
- No transporting unauthorized passengers
- Report any accident, ticket, or vehicle issue immediately to [Contact]

## Maintenance
Drivers are responsible for [routine checks — fuel, tire pressure] and reporting maintenance needs promptly to [Fleet Manager/Contact].

## Accident Procedure
1. Ensure safety and call emergency services if needed.
2. Do not admit fault at the scene.
3. Document the scene (photos, other party's information).
4. Report the accident to [Company Contact] and insurance within [Timeframe].

## Violations
Violation of this policy may result in loss of vehicle privileges and/or disciplinary action.

---
Acknowledged by: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. A company can be held vicariously liable for an employee's conduct while driving a company vehicle — regular MVR checks and a clear no-phone rule are two of the most effective ways to actually reduce that exposure.*`,
  },
  {
    slug: "quit-claim-deed-template",
    name: "Quit Claim Deed",
    seoTitle: "Free Quit Claim Deed Template",
    description: "Free quit claim deed template — transfers whatever interest a grantor has in a property, without warranting clear title.",
    category: "Real Estate",
    bodyMarkdown: `# Quit Claim Deed
...
For and in consideration of [Amount/"love and affection"/other consideration], the Grantor does hereby remise, release, and forever quitclaim to the Grantee all of Grantor's right, title, and interest in and to the property described above.

## No Warranty of Title
This deed conveys only whatever interest the Grantor actually has, if any. Grantor makes no warranty as to the validity of title, and does not warrant the property against claims by third parties.
...
*This document is provided for informational and educational purposes only and does not constitute legal advice. A quitclaim deed transfers NO guarantee of clear title — it's typically used between parties who already trust each other (family transfers, divorce settlements, adding a spouse to title), not in an arm's-length sale where a warranty deed is standard. Recording requirements and exact language vary by state.*`,
  },
  {
    slug: "apartment-rental-application-template",
    name: "Apartment Rental Application",
    seoTitle: "Free Apartment Rental Application Template",
    description: "Free apartment rental application template for prospective tenants to submit their information to a landlord or property manager.",
    category: "Real Estate",
    bodyMarkdown: `# Apartment Rental Application

**Property Address Applying For:** [Address]
**Desired Move-In Date:** [Date]

## Applicant Information
Name: [Name] · DOB: [Date] · SSN (last 4): [XXXX]
Current address: [Address] · Time at address: [Duration]
Phone: [Phone] · Email: [Email]

## Employment & Income
Employer: [Name] · Position: [Title] · Length of employment: [Duration]
Monthly gross income: [Amount] · Supervisor contact: [Name, Phone]

## Rental History
Current landlord: [Name, Phone] · Reason for moving: [Reason]
Previous landlord (if applicable): [Name, Phone]

## Occupants
Number of additional occupants: [Number] · Pets: [Yes/No, describe]

## Authorization
I authorize [Landlord/Property Manager] to verify the information above and to run a credit and background check.

---
Applicant signature: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Landlords must apply the same screening criteria to every applicant — inconsistent standards can expose a landlord to fair housing discrimination claims even when the intent wasn't discriminatory.*`,
  },
  {
    slug: "mortgage-application-checklist-template",
    name: "Mortgage Application Checklist",
    seoTitle: "Free Mortgage Application Checklist Template",
    description: "Free mortgage application checklist template for organizing the documents a lender typically requires before applying for a home loan.",
    category: "Finance",
    bodyMarkdown: `# Mortgage Application Checklist
...
[ ] Statements for existing mortgages, if any
...
## Additional (as requested by lender)
[ ] Explanation letters for any credit inquiries or large deposits
[ ] Divorce decree / child support documentation, if applicable

*Gathering everything on this list BEFORE applying (not scrambling after the lender asks) is what actually speeds up mortgage approval — most delays come from back-and-forth document requests, not the underwriting itself.*`,
  },
  {
    slug: "anti-bullying-policy-template",
    name: "Anti-Bullying Policy",
    seoTitle: "Free Anti-Bullying Policy Template",
    description: "Free anti-bullying policy template for a workplace, school, or organization — defines bullying and the reporting/response process.",
    category: "HR",
    bodyMarkdown: `# Anti-Bullying Policy

**Organization:** [Name] · **Effective Date:** [Date]

## Purpose
[Organization Name] is committed to a respectful environment free from bullying, in addition to and separate from our harassment policy, which covers legally protected characteristics.

## What Counts as Bullying
Repeated, unreasonable behavior directed at an individual that creates a risk to health or safety, including: [verbal abuse, deliberate exclusion, undermining someone's work, intimidation, humiliation in front of others].

## Reporting
Anyone experiencing or witnessing bullying should report it to [HR/Manager/Designated Contact]. Reports can be made [anonymously, if a system exists / directly].

## Investigation
All reports will be investigated promptly and confidentially, to the extent possible.

## No Retaliation
[Organization Name] prohibits retaliation against anyone who reports bullying in good faith.

## Consequences
Confirmed violations of this policy may result in disciplinary action up to and including termination/expulsion.

---
Adopted by: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Bullying based on a protected characteristic (race, sex, disability, etc.) is also unlawful harassment — make sure this policy works alongside your harassment policy, not as a replacement for it.*`,
  },
  {
    slug: "direct-debit-authorization-form-template",
    name: "Direct Debit Authorization Form",
    seoTitle: "Free Direct Debit Authorization Form Template",
    description: "Free direct debit authorization form template — a customer authorizes a business to automatically debit their bank account for recurring payments.",
    category: "Finance",
    bodyMarkdown: `# Direct Debit Authorization Form

I, [Customer Name], authorize [Company Name] to initiate debit entries to my account indicated below, for [description of what's being paid — e.g. monthly subscription, loan payment].

## Account Information
Bank name: [Name] · Account type: [Checking/Savings]
[Collect routing/account numbers through a secure payment portal, not written on this form.]

## Payment Details
Amount: [Fixed amount / "as billed"] · Frequency: [Monthly/Weekly/etc.]
First debit date: [Date]

## Authorization
This authorization will remain in effect until [Customer Name] cancels it in writing, with [Notice Period] notice. I understand I may cancel or change this authorization by contacting [Company Name] at [Contact Info].

---
Customer signature: ______________________  Date: ____________

*Collecting the actual account and routing numbers through a secure payment processor's own form — not a plain document like this one — is what keeps sensitive bank details from sitting in an email inbox or filing cabinet.*`,
  },
  {
    slug: "absence-excuse-form-template",
    name: "Absence Excuse Form",
    seoTitle: "Free Absence Excuse Form Template",
    description: "Free absence excuse form template for an employee or student to document the reason for an absence.",
    category: "HR",
    bodyMarkdown: `# Absence Excuse Form

**Name:** [Name] · **Date(s) of Absence:** [Date(s)]

## Reason for Absence
[ ] Illness  [ ] Medical appointment  [ ] Family emergency  [ ] Bereavement  [ ] Other: ______

## Details
[Brief description — only as much detail as required by policy; medical details should stay confidential.]

## Supporting Documentation
[ ] Doctor's note attached (if required by policy for absences over [X] days)
[ ] Not applicable

## Impact on Work/Coursework
[Any missed deadlines, meetings, or coursework, and the plan to catch up.]

---
Submitted by: ______________________  Date: ____________
Approved by: ______________________  Date: ____________

*Requiring only what your actual attendance policy calls for (not demanding a doctor's note for every single-day absence) keeps this process from feeling punitive while still creating a documented record.*`,
  },
  {
    slug: "letter-of-intent-joint-venture-template",
    name: "Letter of Intent for Joint Venture",
    seoTitle: "Free Letter of Intent for Joint Venture Template",
    description: "Free letter of intent template outlining the preliminary terms two companies agree to before forming a formal joint venture.",
    category: "Business",
    bodyMarkdown: `# Letter of Intent for Joint Venture

**Party A:** [Company Name] · **Party B:** [Company Name] · **Date:** [Date]

This Letter of Intent outlines the parties' shared intent to form a joint venture for the purpose of [Description of the joint venture's business purpose].

## Proposed Structure
[e.g. new jointly-owned entity, contractual joint venture — specify.]

## Ownership/Contribution Split
Party A: [%/contribution] · Party B: [%/contribution]

## Key Terms Under Discussion
1. [Term — e.g. governance/decision-making]
2. [Term — e.g. profit distribution]
3. [Term — e.g. exit/dissolution provisions]

## Exclusivity and Confidentiality
The parties agree to negotiate exclusively with each other regarding this venture for [Period], and to keep discussions confidential.

## Non-Binding Nature
Except for the confidentiality and exclusivity provisions above, this Letter of Intent is non-binding and does not obligate either party to complete the joint venture.

---
Party A: ______________________  Date: ____________
Party B: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Being explicit about which sections are binding (confidentiality/exclusivity) versus non-binding (everything else) is what prevents a preliminary LOI from being misread later as a completed, enforceable joint venture agreement.*`,
  },
  {
    slug: "odometer-disclosure-statement-template",
    name: "Odometer Disclosure Statement",
    seoTitle: "Free Odometer Disclosure Statement Template",
    description: "Free odometer disclosure statement template — required when transferring ownership of most vehicles, certifying the true mileage.",
    category: "Legal",
    bodyMarkdown: `# Odometer Disclosure Statement

**Vehicle:** [Year, Make, Model] · **VIN:** [VIN Number]
**Seller:** [Name] · **Buyer:** [Name] · **Date of Sale:** [Date]

## Odometer Reading
Seller states that the odometer now reads: **[Mileage]** miles, and that to the best of Seller's knowledge, this reflects the actual mileage of the vehicle, UNLESS one of the following applies:
...
[ ] The mileage stated does NOT reflect the actual mileage due to odometer replacement.

## Certification
Federal law and state law require that the seller state the mileage in connection with the transfer of ownership. Failure to complete or providing a false statement may result in fines and/or imprisonment.

---
Seller signature: ______________________  Date: ____________
Buyer signature: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Federal law (49 U.S.C. § 32705) and most states require this disclosure on nearly every used vehicle title transfer — many states provide their own official form, often built directly into the title itself, which should be used instead of a generic one when available.*`,
  },
  {
    slug: "statement-of-interest-template",
    name: "Statement of Interest",
    seoTitle: "Free Statement of Interest Template",
    description: "Free statement of interest template for expressing interest in a position, program, or opportunity before a formal application.",
    category: "Business",
    bodyMarkdown: `# Statement of Interest

[Date]

Dear [Recipient Name],

I am writing to express my interest in [Position/Program/Opportunity] at [Organization Name].

## Why I'm Interested
[Specific reason this opportunity appeals to you — tied to your actual background or goals, not generic enthusiasm.]

## Relevant Background
[Brief summary of the experience or qualifications that make you a strong fit.]

## Next Steps
I would welcome the opportunity to discuss this further, and I'm happy to provide any additional information needed. Thank you for your consideration.

Sincerely,
[Your Name]
[Contact Information]

*A statement of interest is shorter and less formal than a full application or cover letter — use it when an opportunity hasn't been formally posted yet, to signal interest before a full process opens up.*`,
  },
  {
    slug: "statement-of-employment-terms-template",
    name: "Statement of Employment Terms",
    seoTitle: "Free Statement of Employment Terms Template",
    description: "Free statement of employment terms template — a written summary of an employee's core terms of employment, as required in some jurisdictions.",
    category: "HR",
    bodyMarkdown: `# Statement of Employment Terms

**Employer:** [Company Name] · **Employee:** [Name] · **Date:** [Date]

## Position
Job title: [Title] · Start date: [Date] · Reports to: [Manager]

## Compensation
Salary/wage: [Amount] · Pay frequency: [Frequency] · Pay method: [Direct deposit/check]

## Hours
Standard hours: [Hours/week] · Schedule: [Description]
Employment classification: [Exempt/Non-exempt, if applicable]

## Benefits
[Summary of benefits eligibility — health insurance, retirement plan, PTO — with reference to the full benefits summary/handbook.]

## Location
Primary work location: [Address/Remote]

## Notice Period
Either party may terminate employment with [Notice Period] written notice, except in cases of [gross misconduct/immediate termination circumstances].

---
Employer representative: ______________________  Date: ____________
Employee: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Several jurisdictions (including the UK, under the Employment Rights Act) legally require employers to provide a written statement of these core terms within a set period of the start date — confirm your jurisdiction's specific requirement.*`,
  },
  {
    slug: "risk-disclosure-statement-template",
    name: "Risk Disclosure Statement",
    seoTitle: "Free Risk Disclosure Statement Template",
    description: "Free risk disclosure statement template for informing a client or investor of the risks associated with a financial product or investment.",
    category: "Finance",
    bodyMarkdown: `# Risk Disclosure Statement

**Product/Service:** [Description] · **Date:** [Date]

## General Risk Warning
[Investing/trading in [Product] involves risk, including the possible loss of principal. Past performance is not indicative of future results.]

## Specific Risks
- **Market risk:** [Description — value can fluctuate due to market conditions]
- **Liquidity risk:** [Description — may not be able to sell/exit quickly at a fair price]
- **[Product-specific risk]:** [Description — e.g. leverage risk, currency risk, concentration risk]

## No Guarantee
[Company Name] does not guarantee any specific return or outcome. Any projections shown are hypothetical and not a promise of future performance.

## Client Acknowledgment
By signing below, I confirm I have read and understood this risk disclosure and that I am investing/participating based on my own assessment of these risks.

---
Client signature: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal, tax, or investment advice. Financial products and investment advisory activity are regulated (e.g. by the SEC/FINRA in the US) — a real risk disclosure should be reviewed by a licensed securities attorney to ensure it meets your specific regulatory disclosure obligations.*`,
  },
  {
    slug: "line-of-credit-agreement-template",
    name: "Line of Credit Agreement",
    seoTitle: "Free Line of Credit Agreement Template",
    description: "Free line of credit agreement template — a lender extends a revolving credit facility that a borrower can draw against as needed.",
    category: "Finance",
    bodyMarkdown: `# Line of Credit Agreement

**Lender:** [Name] · **Borrower:** [Name] · **Date:** [Date]

## 1. Credit Line
Lender agrees to extend a revolving line of credit to Borrower up to a maximum of [Amount] ("the Credit Limit").

## 2. Draws
Borrower may draw on the Credit Line as needed, up to the Credit Limit, by [Method — request in writing, automatic access].

## 3. Interest
Interest accrues on the outstanding balance at [Rate]% per [annum/month], calculated [Method].

## 4. Repayment
Borrower will make minimum payments of [Amount/percentage of balance] by the [Day] of each month. The full outstanding balance is due by [Date/upon demand/at the end of the term].

## 5. Fees
[Any draw fees, annual fees, or late payment fees.]

## 6. Default
Borrower is in default if any payment is more than [Number] days late. Upon default, Lender may [demand immediate repayment of the full balance / other remedies].

## 7. Security (if applicable)
[Describe any collateral securing this credit line.]

---
Lender: ______________________  Date: ____________
Borrower: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Lending activity is regulated in most jurisdictions (usury limits, disclosure requirements) — a lender extending credit as a business, not a one-time personal favor, should confirm compliance with applicable lending laws.*`,
  },
  {
    slug: "affidavit-of-service-template",
    name: "Affidavit of Service",
    seoTitle: "Free Affidavit of Service Template",
    description: "Free affidavit of service template — sworn proof that legal documents were properly delivered to a party in a legal proceeding.",
    category: "Legal",
    bodyMarkdown: `# Affidavit of Service
...
## 1. Capacity
I am over the age of 18 and not a party to the action described below.

## 2. Documents Served
On [Date], I served the following documents: [List documents — e.g. Summons and Complaint] upon [Recipient Name], in the matter of [Case Name/Number].

## 3. Method of Service
[ ] Personal service — delivered directly to the recipient at [Address, Time].
[ ] Substituted service — left with [Name/Relationship] at [Address], a person of suitable age and discretion residing/working there.
[ ] Other method: [Describe, per applicable rules]

## 4. Description of Recipient (if personal service)
Approximate age: [Age] · Sex: [Sex] · Other identifying details: [Details]

---
Server signature: ______________________  Date: ____________

**Notarization:**
Subscribed and sworn before me this ____ day of __________, 20__.
Notary Public: ______________________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Rules for valid service (who can serve, acceptable methods, required detail) vary by jurisdiction and court — confirm your specific court's requirements before relying on this affidavit to prove service.*`,
  },
  {
    slug: "employee-grievance-form-template",
    name: "Employee Grievance Form",
    seoTitle: "Free Employee Grievance Form Template",
    description: "Free employee grievance form template for an employee to formally raise a workplace complaint or concern.",
    category: "HR",
    bodyMarkdown: `# Employee Grievance Form

**Employee:** [Name] · **Date Filed:** [Date]
**Department:** [Department] · **Supervisor:** [Name]

## Nature of Grievance
[ ] Working conditions  [ ] Treatment by a colleague/supervisor  [ ] Policy application  [ ] Pay/benefits  [ ] Other: ______

## Description
[Factual, specific description of the issue — dates, people involved, what happened.]

## Prior Attempts to Resolve
[Any informal steps already taken to address this issue, and the outcome.]
...
Received by: ______________________  Date: ____________
Investigation notes: [Attach separately]
Resolution: [Describe outcome and date communicated to employee]

*A grievance process that's actually used (not just a form nobody knows exists) surfaces problems while they're still small — make sure employees know this exists and won't face retaliation for using it.*`,
  },
  {
    slug: "graphic-design-request-form-template",
    name: "Graphic Design Request Form",
    seoTitle: "Free Graphic Design Request Form Template",
    description: "Free graphic design request form template for submitting a design brief to an internal designer or agency.",
    category: "Business",
    bodyMarkdown: `# Graphic Design Request Form

**Requested by:** [Name/Department] · **Date Needed By:** [Date]

## Project Details
Project name: [Name] · Type: [Social graphic/Print/Web/Presentation/etc.]

## Description
[What needs to be designed and why — the goal, not just "make a flyer."]

## Specifications
Dimensions/format: [Dimensions] · Color mode: [RGB/CMYK] · File formats needed: [PNG/PDF/AI/etc.]

## Content to Include
[Text copy, logos, images to be used — attach or link source files.]

## Brand Guidelines
[ ] Follow brand guide at [Link] · [ ] Custom look — describe: ______

## Reference/Inspiration
[Links or examples of the desired style]

## Approval
Who needs to approve the final design before it's used: [Name]

*A request that includes actual copy and reference examples (not just "surprise me") is what gets a usable first draft instead of three rounds of guessing what you meant.*`,
  },
  {
    slug: "jury-duty-excuse-letter-template",
    name: "Jury Duty Excuse Letter",
    seoTitle: "Free Jury Duty Excuse Letter Template",
    description: "Free jury duty excuse letter template — requests a postponement or exemption from jury service.",
    category: "Legal",
    bodyMarkdown: `# Jury Duty Excuse Letter
...
**RE: Request for Excusal/Postponement — Juror ID/Summons #[Number]**

Dear Clerk of Court,

I am writing to request [an excusal from / a postponement of] jury service scheduled for [Date], for the following reason:

## Reason
[ ] Medical (attach documentation if required)
[ ] Financial hardship
[ ] Sole caregiver responsibilities
[ ] Pre-scheduled travel/commitment: [Details]
[ ] Other: [Reason]

## Supporting Documentation
[Attach a doctor's note, employer letter, or other documentation as required by the court's specific rules.]

If a postponement is more appropriate than an excusal, I would request rescheduling to [Alternative timeframe, if the court allows a preference].

Thank you for your consideration.

Sincerely,
[Your Name]
[Juror ID, Contact Information]

*This document is provided for informational and educational purposes only and does not constitute legal advice. Every court has its own specific process and acceptable reasons for excusal (often stated on the back of the jury summons itself) — follow your court's exact instructions and deadline rather than assuming this general format alone will be accepted.*`,
  },
  {
    slug: "credit-bureau-dispute-letter-template",
    name: "Credit Bureau Dispute Letter",
    seoTitle: "Free Credit Bureau Dispute Letter Template",
    description: "Free credit bureau dispute letter template for disputing inaccurate information on a credit report.",
    category: "Finance",
    bodyMarkdown: `# Credit Bureau Dispute Letter
...
**RE: Dispute of Inaccurate Information — [Your Name], [Your Address]**

To Whom It May Concern,

I am writing to dispute the following information in my credit file. The item(s) listed below [are inaccurate/incomplete/not mine], and I am requesting that it be corrected or removed.

## Disputed Item(s)
| Creditor/Account | Account # | Reason for Dispute |
|---------------------|---------------|-------------------------|
| [Creditor] | [Account #] | [e.g. "not my account," "paid in full but shown as delinquent," "duplicate entry"] |

## Supporting Documentation
[List enclosed documents — payment records, identity theft report, etc.]

Under the Fair Credit Reporting Act, I request that you investigate this matter and correct my credit report within 30 days.

Please send my corrected credit report to the address above once your investigation is complete.

Sincerely,
[Your Name]
[SSN (last 4 digits)] · [Date of Birth]

*This document is provided for informational and educational purposes only and does not constitute legal advice. Under the FCRA, credit bureaus generally must investigate a written dispute within 30 days — sending this by certified mail creates proof of the date you disputed, which matters if the timeline is later contested.*`,
  },
  {
    slug: "notice-of-dishonored-check-template",
    name: "Notice of Dishonored (Bad) Check",
    seoTitle: "Free Notice of Dishonored Check Template",
    description: "Free notice of dishonored check template — formally demands payment after a check bounces, often a required step before pursuing bad-check charges.",
    category: "Finance",
    bodyMarkdown: `# Notice of Dishonored Check
...
**RE: Dishonored Check #[Number], dated [Date], in the amount of [Amount]**

Dear [Recipient Name],

This letter serves as formal notice that the check referenced above, which you issued to [Your Name/Company], was returned by the bank marked [insufficient funds / account closed / other reason].

## Demand for Payment
You are required to pay the full amount of [Amount], plus any applicable returned-check fee of [Amount] as permitted under [State] law, within [Number] days of this notice.

## Total Amount Due
Check amount: [Amount] + Returned-check fee: [Amount] = **Total: [Amount]**

## Consequences of Non-Payment
If payment is not received within the stated period, we may pursue civil action for the amount owed, including statutory damages available under [State] law, and/or refer this matter for criminal prosecution where applicable.

Please remit payment to [Payment Instructions] by [Date].

Sincerely,
[Your Name/Company]

*This document is provided for informational and educational purposes only and does not constitute legal advice. Many states require this kind of formal written demand — often with specific required language and a minimum waiting period — before a bad check can support a criminal complaint or a statutory damages claim; confirm your state's exact requirements.*`,
  },
  {
    slug: "employment-contract-renewal-letter-template",
    name: "Employment Contract Renewal Letter",
    seoTitle: "Free Employment Contract Renewal Letter Template",
    description: "Free employment contract renewal letter template for extending a fixed-term employment contract.",
    category: "HR",
    bodyMarkdown: `# Employment Contract Renewal Letter

[Date]

Dear [Employee Name],

We're pleased to confirm that your current employment contract, set to expire on [Current End Date], will be renewed for an additional term.

## Renewal Terms
New contract term: [Start Date] – [End Date]
Position: [Title, if unchanged, or note any change]
Salary: [Amount, if unchanged, or note any change]
[Any other terms being updated for the new term.]

## Confirmation
Please sign below to confirm your acceptance of this renewal. All other terms of your original employment agreement remain in effect unless specifically changed above.

We're glad to have you continuing with the team.

Sincerely,
[Manager Name, Title]

---
Employee acceptance: ______________________  Date: ____________

*Sending this well before the current contract expires (not on the last day) avoids any gap in employment status and gives the employee time to review any changed terms before signing.*`,
  },
  {
    slug: "subcontracting-proposal-letter-template",
    name: "Subcontracting Proposal Letter",
    seoTitle: "Free Subcontracting Proposal Letter Template",
    description: "Free subcontracting proposal letter template — a contractor proposes taking on a specific portion of a larger project as a subcontractor.",
    category: "Business",
    bodyMarkdown: `# Subcontracting Proposal Letter

[Date]

Dear [Prime Contractor/Contact Name],

I'm writing to propose [Your Company Name] as a subcontractor for [portion of scope] on the [Project Name] project.

## Proposed Scope
[Specific work you would perform — be precise about what's included and excluded.]

## Qualifications
[Relevant experience, licenses, or certifications that make you a strong fit for this specific scope.]

## Pricing
[Fixed price / hourly rate], estimated total: [Amount], based on [Assumptions/scope described above].

## Timeline
Estimated to complete this scope within [Duration], assuming a start date of [Date].

## References
[1-2 relevant past projects with contact information, if useful.]

I'd welcome the opportunity to discuss this further and answer any questions.

Sincerely,
[Your Name, Company]

*Being explicit about scope boundaries (what's included AND excluded) in the proposal itself — not just verbally — is what prevents scope-creep disputes once the subcontract is actually signed.*`,
  },
  {
    slug: "executive-employment-agreement-template",
    name: "Executive Employment Agreement",
    seoTitle: "Free Executive Employment Agreement Template",
    description: "Free executive employment agreement template covering compensation, equity, severance, and restrictive covenants for a senior executive hire.",
    category: "Business",
    bodyMarkdown: `# Executive Employment Agreement

**Company:** [Company Name] · **Executive:** [Name]
**Position:** [Title] · **Effective Date:** [Date]

## 1. Duties
Executive will serve as [Title], reporting to [Board/CEO], with duties consistent with that role.

## 2. Compensation
Base salary: [Amount] per year · Annual bonus target: [%/Amount], based on [Criteria]
Equity: [Number] options/RSUs, vesting over [Schedule].

## 3. Benefits
Executive is eligible for [Company Name]'s standard benefits plans, plus: [Any executive-specific perks].

## 4. Term and Termination
[ ] At-will employment.
[ ] Fixed term of [Duration], renewable by mutual agreement.

## 5. Severance
If terminated without Cause, Executive will receive: [Severance terms — e.g. months of salary, COBRA coverage, accelerated vesting].

## 6. Restrictive Covenants
Executive agrees to [confidentiality / non-compete for [Period] where enforceable / non-solicitation of employees and customers for [Period]].

## 7. Change of Control
[Any provisions triggered by a company sale or merger — e.g. accelerated vesting.]

---
Company: ______________________  Date: ____________
Executive: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Non-compete enforceability varies enormously by state (some, like California, ban them almost entirely) — have an employment attorney review the restrictive covenants section against the specific state law that will govern this agreement.*`,
  },
  {
    slug: "security-deposit-refund-receipt-template",
    name: "Security Deposit Refund Receipt",
    seoTitle: "Free Security Deposit Refund Receipt Template",
    description: "Free security deposit refund receipt template — documents the amount of a tenant's deposit returned and any deductions made.",
    category: "Real Estate",
    bodyMarkdown: `# Security Deposit Refund Receipt

**Landlord:** [Name] · **Tenant:** [Name]
**Property:** [Address] · **Lease Term:** [Start] – [End]

## Deposit Summary
Original deposit held: [Amount]

## Deductions (if any)
| Reason | Amount |
|--------|--------|
| [e.g. Cleaning beyond normal wear] | [Amount] |
| [e.g. Repair of damage] | [Amount] |

**Total deductions: [Amount]**
**Amount refunded to tenant: [Amount]**

## Refund Method and Date
Refunded via [Check/Transfer] on [Date].

---
Landlord signature: ______________________  Date: ____________
Tenant signature (acknowledging receipt): ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Most states require landlords to return a deposit (or an itemized list of deductions) within a specific deadline — commonly 14-30 days after move-out — and some impose penalties for missing it, so send this promptly.*`,
  },
  {
    slug: "speaker-agreement-template",
    name: "Speaker Agreement",
    seoTitle: "Free Speaker Agreement Template",
    description: "Free speaker agreement template for engaging a speaker for a conference, event, or webinar.",
    category: "Business",
    bodyMarkdown: `# Speaker Agreement

**Event Organizer:** [Name] · **Speaker:** [Name]
**Event:** [Name] · **Date/Time:** [Date, Time]

## 1. Engagement
Speaker agrees to present [Session Title/Topic] at the Event, for approximately [Duration].

## 2. Compensation
[ ] No fee — speaking is unpaid/for exposure.
[ ] Speaker fee of [Amount], payable [Terms].
[ ] Travel and accommodation covered, per [Policy/details].

## 3. Materials
Speaker will provide [slides/handouts] by [Date] for review, and grants Organizer permission to [distribute materials to attendees / record the session].

## 4. Recording and Use of Likeness
[ ] Organizer may record the session and use it for [on-demand replay / marketing], with Speaker's name and likeness credited.
[ ] No recording permitted.

## 5. Cancellation
[Notice required for either party to cancel, and any consequences — e.g. no fee if cancelled by Speaker with insufficient notice.]

---
Organizer: ______________________  Date: ____________
Speaker: ______________________  Date: ____________

*Clarifying recording and reuse rights upfront (Section 4) avoids a common dispute — many speakers are fine presenting live but don't want their talk repurposed indefinitely in marketing content without being asked first.*`,
  },
  {
    slug: "pet-adoption-agreement-template",
    name: "Pet Adoption Agreement",
    seoTitle: "Free Pet Adoption Agreement Template",
    description: "Free pet adoption agreement template for a shelter, rescue, or individual rehoming a pet to a new owner.",
    category: "Legal",
    bodyMarkdown: `# Pet Adoption Agreement

**Adopting Organization/Individual:** [Name]
**Adopter:** [Name]
**Pet:** [Name, Species, Breed, Age, ID/microchip # if applicable]
**Date:** [Date]

## 1. Transfer of Ownership
[Organization/Individual] transfers ownership of the pet described above to Adopter, effective the date of this Agreement.

## 2. Adoption Fee
Adopter has paid an adoption fee of [Amount], covering [what's included — spay/neuter, vaccinations, microchip].

## 3. Adopter's Commitments
Adopter agrees to:
- Provide proper food, shelter, exercise, and veterinary care
- Not use the pet for breeding, fighting, or lab research
- Contact [Organization] before rehoming the pet, giving [Organization] the right of first refusal to take the pet back

## 4. Health Disclosure
[Organization/Individual] discloses the following known health conditions: [List, or "none known"].

## 5. Return Policy
[If applicable: Adopter may return the pet to [Organization] within [Period] if the adoption doesn't work out, per [refund policy].]

---
Adopter signature: ______________________  Date: ____________
Organization/Individual representative: ______________________  Date: ____________

*The right-of-first-refusal clause (Section 3) is standard for reputable shelters and rescues — it means a pet that doesn't work out comes back to people who know its history, rather than being passed along informally or surrendered to an overcrowded shelter.*`,
  },
  {
    slug: "salary-deferral-agreement-template",
    name: "Salary Deferral Agreement",
    seoTitle: "Free Salary Deferral Agreement Template",
    description: "Free salary deferral agreement template — an employee agrees to defer part of their compensation to a later date, common at early-stage startups.",
    category: "Finance",
    bodyMarkdown: `# Salary Deferral Agreement

**Company:** [Company Name] · **Employee:** [Name] · **Date:** [Date]

## 1. Deferral
Employee agrees to defer [%/Amount] of their salary, from [Start Date] until [End Date/triggering event], due to [Reason — e.g. company cash flow].

## 2. Repayment
Deferred amounts will be repaid to Employee [upon a triggering event, e.g. next funding round / by a specific date], [with/without] interest at [Rate]%.

## 3. Priority
[State how this deferred amount is treated relative to other company obligations — e.g. "senior to other unsecured deferred compensation" — if relevant.]

## 4. Company Insolvency
If the Company becomes insolvent or is dissolved before repayment, Employee acknowledges that [describe how the deferred amount will be treated — e.g. as an unsecured creditor claim].

## 5. Tax Treatment
[Note that deferred compensation may have tax implications under applicable law (e.g. IRC Section 409A in the US) and that Employee should consult a tax advisor.]

---
Company: ______________________  Date: ____________
Employee: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal or tax advice. In the US, deferred compensation arrangements that aren't structured correctly can trigger immediate taxation and penalties under Section 409A — have this reviewed by an attorney or tax advisor before using it for real deferred pay.*`,
  },
  {
    slug: "household-budget-template",
    name: "Household Budget Template",
    seoTitle: "Free Household Budget Template",
    description: "Free household budget template for tracking monthly income, expenses, and savings for a family or household.",
    category: "Finance",
    bodyMarkdown: `# Household Budget
...
| Goal | Amount |
|------|--------|
| [e.g. Emergency fund] | [Amount] |

**Total Expenses + Savings:** [Amount]
**Remaining/Shortfall:** [Total Income − Total Expenses − Savings]

*Tracking "budgeted vs. actual" side by side (not just planning ahead) is what actually reveals where a household consistently overspends — the gap between the two columns is more useful than either number alone.*`,
  },
  {
    slug: "royalty-statement-template",
    name: "Royalty Statement",
    seoTitle: "Free Royalty Statement Template",
    description: "Free royalty statement template for reporting sales/usage and royalty payments owed to an author, artist, or licensor.",
    category: "Finance",
    bodyMarkdown: `# Royalty Statement

**Licensor/Author:** [Name] · **Licensee/Publisher:** [Name]
**Reporting Period:** [Period] · **Statement Date:** [Date]

## Sales/Usage Summary
| Product/Title | Units Sold/Uses | Unit Price | Gross Revenue | Royalty Rate | Royalty Owed |
|--------------------|----------------------|-----------------|--------------------|------------------|-------------------|
| [Product] | [Units] | [Price] | [Amount] | [%] | [Amount] |

**Total Royalty Owed This Period:** [Amount]

## Prior Balance
Advance/reserve balance carried forward: [Amount]
Amount recouped this period: [Amount]

**Net Amount Due to Licensor/Author: [Amount]**

## Payment
Payment will be made via [Method] by [Date], per the terms of the underlying license/publishing agreement.

---
Prepared by: ______________________  Date: ____________

*Showing the recoupment balance clearly (not just the current period's number) is what lets an author or licensor verify an advance is being tracked correctly — this is the single most common source of royalty disputes.*`,
  },
  {
    slug: "unemployment-benefits-appeal-letter-template",
    name: "Unemployment Benefits Appeal Letter",
    seoTitle: "Free Unemployment Benefits Appeal Letter Template",
    description: "Free unemployment benefits appeal letter template for appealing a denial or disputed determination on an unemployment claim.",
    category: "Legal",
    bodyMarkdown: `# Unemployment Benefits Appeal Letter

[Date]

[State Unemployment Office/Appeals Board]
[Address]

**RE: Appeal of Determination — Claim #[Number], [Your Name]**

To Whom It May Concern,

I am writing to formally appeal the determination dated [Date], which [denied my claim / determined I was ineligible for benefits], on the following basis: [State the stated reason for denial].

## Grounds for Appeal
[Explain specifically why you believe the determination was incorrect — e.g. "I was laid off due to a company-wide reduction in force, not terminated for misconduct as stated."]

## Supporting Evidence
[List documents attached — termination letter, separation notice, witness statements, etc.]

I request that this determination be reversed and that my claim for benefits be approved. Please advise me of the date and process for any hearing related to this appeal.

Sincerely,
[Your Name]
[Claimant ID, Contact Information]

*This document is provided for informational and educational purposes only and does not constitute legal advice. Unemployment appeals have strict, short deadlines (often 10-30 days from the determination date, varying by state) — file immediately, since missing the deadline typically forfeits the right to appeal at all.*`,
  },
  {
    slug: "distributor-agreement-non-exclusive-template",
    name: "Distributor Agreement (Non-Exclusive)",
    seoTitle: "Free Non-Exclusive Distributor Agreement Template",
    description: "Free non-exclusive distributor agreement template — a manufacturer/supplier appoints a distributor to resell products without exclusivity.",
    category: "Business",
    bodyMarkdown: `# Distributor Agreement (Non-Exclusive)

**Supplier:** [Company Name] · **Distributor:** [Company Name] · **Date:** [Date]

## 1. Appointment
Supplier appoints Distributor as a non-exclusive distributor of [Products] within [Territory]. Supplier reserves the right to appoint other distributors and to sell directly within the same Territory.

## 2. Pricing and Orders
Distributor will purchase Products at [Wholesale price/discount from list price], subject to Supplier's standard order terms and minimum order quantities of [Amount].

## 3. Distributor's Responsibilities
Distributor will [market and sell the Products in good faith, maintain adequate inventory, provide reasonable customer support], using Supplier's trademarks only as authorized.

## 4. Payment Terms
[Terms — e.g. Net 30 from invoice date.]

## 5. Term and Termination
This Agreement runs for [Term] and renews automatically unless either party provides [Notice Period] notice of non-renewal. Either party may terminate for material breach not cured within [Cure Period].

## 6. No Exclusivity
Nothing in this Agreement grants Distributor any exclusive territory or product rights.

---
Supplier: ______________________  Date: ____________
Distributor: ______________________  Date: ____________

*Being explicit that this is non-exclusive (Section 6) matters — a distributor who invests heavily in marketing a product only to find a competing distributor selling the same line next door has a real basis for a dispute if this wasn't made clear upfront.*`,
  },
  {
    slug: "financial-services-agreement-template",
    name: "Financial Services Agreement",
    seoTitle: "Free Financial Services Agreement Template",
    description: "Free financial services agreement template for a firm providing advisory, bookkeeping, or financial management services to a client.",
    category: "Finance",
    bodyMarkdown: `# Financial Services Agreement

**Provider:** [Firm Name] · **Client:** [Name] · **Effective Date:** [Date]

## 1. Services
Provider will perform the following services for Client: [e.g. bookkeeping, financial planning, advisory services — be specific about scope].

## 2. Fees
[Flat fee of [Amount] per [period] / hourly rate of [Amount] / percentage of assets under management of [%]].

## 3. Client Responsibilities
Client will provide accurate and timely financial information and documentation needed for Provider to perform the services.

## 4. Confidentiality
Provider will keep Client's financial information confidential, except as required by law or authorized by Client.

## 5. No Guarantee
[If advisory in nature: Provider does not guarantee any specific financial outcome or investment performance.]
...
*This document is provided for informational and educational purposes only and does not constitute legal advice. Providing investment advice for compensation generally requires registration as an investment adviser (e.g. with the SEC or a state regulator in the US) — confirm the provider's services and licensing align before signing.*`,
  },
  {
    slug: "blanket-purchase-agreement-template",
    name: "Blanket Purchase Agreement",
    seoTitle: "Free Blanket Purchase Agreement Template",
    description: "Free blanket purchase agreement template — sets pre-negotiated terms for repeated future purchases from a vendor over a period, without a separate contract each time.",
    category: "Business",
    bodyMarkdown: `# Blanket Purchase Agreement

**Buyer:** [Company Name] · **Vendor:** [Company Name] · **Date:** [Date]

## 1. Purpose
This Agreement establishes pre-negotiated pricing and terms for Buyer's anticipated recurring purchases of [Products/Services] from Vendor over the term below, without requiring a new contract for each order.

## 2. Term
This Agreement is effective from [Start Date] to [End Date].

## 3. Pricing
| Item/Service | Unit Price | Volume Discount Tiers |
|-------------------|----------------|-----------------------------|
| [Item] | [Price] | [Tiers, if applicable] |

## 4. Estimated Volume (Non-Binding)
Buyer estimates purchasing approximately [Volume/Amount] over the term, though this Agreement does not obligate Buyer to purchase any minimum amount unless stated otherwise.

## 5. Ordering Process
Individual orders will be placed via [Purchase order/method], referencing this Agreement's terms, and are governed by the pricing and terms set here.

## 6. Delivery and Payment
[Standard delivery timelines and payment terms, e.g. Net 30, applicable to all orders under this Agreement.]

---
Buyer: ______________________  Date: ____________
Vendor: ______________________  Date: ____________

*A blanket purchase agreement's main value is locking in pricing and terms once instead of renegotiating every order — be clear (Section 4) about whether there's an actual minimum purchase commitment, since that changes the deal significantly for both sides.*`,
  },
  {
    slug: "statement-of-no-loss-template",
    name: "Statement of No Loss",
    seoTitle: "Free Statement of No Loss Template",
    description: "Free statement of no loss template — an insurance applicant certifies no loss or damage has occurred to the insured property since the quote was issued.",
    category: "Finance",
    bodyMarkdown: `# Statement of No Loss

**Applicant/Insured:** [Name]
**Policy/Quote Reference:** [Number]
**Property/Item Insured:** [Description]
**Date:** [Date]

I, [Name], certify that as of the date of this statement, no loss, damage, or claim has occurred to the property/item described above since the date the insurance quote referenced was issued on [Quote Date].

## Certification
I understand that this statement is required by [Insurance Company Name] as a condition of binding/issuing the policy, and that providing false information may void coverage.

---
Applicant signature: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal or insurance advice. Insurers commonly require this statement immediately before a policy takes effect — if a loss DID occur in that window, disclose it; misrepresenting this can give the insurer grounds to deny a future claim entirely.*`,
  },
  {
    slug: "master-lease-agreement-template",
    name: "Master Lease Agreement",
    seoTitle: "Free Master Lease Agreement Template",
    description: "Free master lease agreement template — an investor leases an entire property from the owner with the right to sublease individual units.",
    category: "Real Estate",
    bodyMarkdown: `# Master Lease Agreement

**Owner (Landlord):** [Name] · **Master Tenant:** [Name]
**Property:** [Address] · **Effective Date:** [Date]

## 1. Lease of Entire Property
Owner leases the entire property described above to Master Tenant, who will have the right to operate, manage, and sublease individual units to end tenants, subject to this Agreement.

## 2. Rent
Master Tenant will pay Owner fixed rent of [Amount] per month, regardless of Master Tenant's occupancy or sublease income from the property.

## 3. Master Tenant's Rights
Master Tenant may sublease units, collect rent from subtenants, and make [minor/major, specify] improvements, subject to [Owner's prior approval for major changes].

## 4. Owner's Retained Obligations
[State whether Owner remains responsible for major structural repairs, property taxes, insurance, or whether these shift to Master Tenant.]

## 5. Term
This Agreement runs for [Term], with [renewal options, if any].

## 6. Default
If Master Tenant fails to pay rent to Owner, [existing subtenant leases remain in effect / Owner may terminate this Agreement and step into Master Tenant's role directly], per [applicable state law on master lease defaults].

---
Owner: ______________________  Date: ____________
Master Tenant: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. Master lease structures are popular in real estate investing precisely because they let an investor control a property without buying it — but they carry real risk if the master tenant can't cover rent regardless of actual occupancy, so cash-flow assumptions should be conservative.*`,
  },
  {
    slug: "three-day-notice-to-pay-rent-or-quit-template",
    name: "Three-Day Notice to Pay Rent or Quit",
    seoTitle: "Free Three-Day Notice to Pay Rent or Quit Template",
    description: "Free three-day notice to pay rent or quit template — a landlord's formal demand for overdue rent before starting eviction proceedings.",
    category: "Real Estate",
    bodyMarkdown: `# Three-Day Notice to Pay Rent or Quit

**To:** [Tenant Name]
**Property Address:** [Address]
**Date:** [Date]

You are hereby notified that rent in the amount of **[Amount]** for the period of [Period] is now due and unpaid on the premises described above, which you currently occupy.

## Demand
Within **THREE (3) DAYS** after service of this notice (excluding the day of service), you are required to either:

1. **Pay** the full amount of rent due, **[Amount]**, to [Landlord Name] at [Payment Address/Method]; OR
2. **Vacate and surrender** possession of the premises.

## Consequence of Failure to Comply
If you fail to do either within the time stated, legal proceedings will be instituted against you to recover possession of the premises, unpaid rent, and any costs and fees permitted by law.

---
Landlord/Agent: ______________________  Date: ____________

*This document is provided for informational and educational purposes only and does not constitute legal advice. The exact notice period (3 days is common but not universal), required language, and permitted delivery method are set by state law and vary significantly — use your state's specific required form where one exists, since an improperly served notice can delay or derail an eviction case entirely.*`,
  },
  {
    slug: "fcra-adverse-action-notice-template",
    name: "FCRA Adverse Action Notice",
    seoTitle: "Free FCRA Adverse Action Notice Template",
    description: "Free FCRA adverse action notice template — notifies a job applicant they were not selected based in part on a background check.",
    category: "HR",
    bodyMarkdown: `# Notice of Adverse Action

[Date]

Dear [Applicant Name],

We are writing to inform you that we have decided not to move forward with your application for [Position], based in whole or in part on information contained in a consumer report obtained about you.

## Consumer Reporting Agency
The report was obtained from: [Background Check Company Name]
[Address] · [Phone Number]

The reporting agency did not make the decision not to hire you and cannot explain the specific reasons for our decision.

## Your Rights
Under the Fair Credit Reporting Act (FCRA), you have the right to:
- Obtain a free copy of the report from the reporting agency above within 60 days
- Dispute the accuracy or completeness of any information in the report directly with the reporting agency

We encourage you to contact the reporting agency if you believe any information in your report is inaccurate.

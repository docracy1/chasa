/**
 * Records the homepage revival-teaser demo to public/videos/docstoc-is-back.webm
 * Run: node apps/web/scripts/record-docstoc-is-back.mjs
 */
...
const demoPath = path.join(__dirname, "demos/docstoc-is-back.html");
const outDir = path.join(root, "apps/web/public/videos");
const outPath = path.join(outDir, "docstoc-is-back.webm");
const posterPath = path.join(outDir, "docstoc-is-back-poster.jpg");
const VIEWPORT = { width: 1280, height: 720 };
/** Keep in sync with total sleep() chain in demos/docstoc-is-back.html (~26s + buffer) */

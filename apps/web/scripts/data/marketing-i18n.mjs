...
export const en = {
  ...
  "home.hero.sub":
    "Paste an overdue invoice. Chasa drafts a follow-up matched to how late it is — warm early, firmer later — so you sound professional, not desperate. Copy, tweak, send from your own inbox.",
...
export const es = {
  ...
  "home.hero.sub":
    "Pega una factura vencida. Chasa redacta un seguimiento según el retraso — amable al inicio, más firme después — para que suenes profesional, no desesperado. Copia, ajusta y envía desde tu bandeja.",
